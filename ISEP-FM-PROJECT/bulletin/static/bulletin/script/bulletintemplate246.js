...
function GenerateBullStaps2Semestre3(){
  ...
  semestreResult2.children[0].children[1].children[2].children[2].innerHTML="Sage-Professionnel"
  //Ligne 4
  ...
  semestreResult2.children[0].children[1].children[6].children[1].innerHTML="DIDACTIQUE DES APS : GY"
  //Ligne 8
...
function BullMDS1(clone, i){
 ...
 var ligneMDS112 = tbody.children[2]
  ...
  for(j=0; j<=ligneMDS113.childElementCount-1; j++){
    ...
    if(j==6){ligneMDS113.children[j].innerHTML = listStudent[i][5][3]
      /*Moyenne4( 
 ...
 var ligneMDS116 = tbody.children[7]
  ...
  for(j=0; j<=ligneMDS117.childElementCount-1; j++){
    ...
    if(j==6){ ligneMDS117.children[j].innerHTML = listStudent[i][9][3]
      /*Moyenne2( 
 ...
 var ligneMDS117b = tbody.children[9]
  ...
  for(j=0; j<=ligne1.childElementCount-1; j++){
    ...
    if(j==4){ v = mydata[2].length-1; ligne1.children[j].innerHTML = `${mydata[2][v]} / 20`}
  }
...
function BullSTAPS2(clone, i){
  ...
  for(j=0; j<=ligneEPS114.childElementCount-1; j++){
   ...
   for(j=0; j<=ligneEPS115a.childElementCount-1; j++){
     ...
     if(j==6){if(listStudent[i][5][5]){ligneEPS115a.children[j].innerHTML = "VALIDEE"}else{ligneEPS115a.children[j].innerHTML ="NON VALIDEE"}}//Mention
     if(j==7){ligneEPS115a.children[j].innerHTML = mydata[4]} //session
     if(j==8){if( (listStudent[i][5][0] + listStudent[i][6][0]+ listStudent[i][7][0] + listStudent[i][8][0] + listStudent[i][9][0] + listStudent[i][10][0]) >= 60){ligneEPS115a.children[j].innerHTML = listStudent[i][5][6]}else{ligneEPS115a.children[j].innerHTML = 0}} //nombre_crédits
   }
  ...
  for(j=0; j<=ligneEPS117.childElementCount-1; j++){
    ...
    if(j==5){val=ligneEPS117.children[2].innerHTML*ligneEPS117.children[3].innerHTML; val=val.toFixed(2); val=parseFloat(val); ligneEPS117.children[j].innerHTML = listStudent[i][12][2]}//total note math * coef
...
function BullEVE(clone, i){
  ...
  for(j=0; j<=ligneMAS315.childElementCount-1; j++){
    ...
    }else{ligneMAS315.children[9].innerHTML = "NON VALIDEE"}}//Mention
    if(j==10){}//Session
...
function Moyenne2(a,b, coef){ 
  a = parseFloat(a); 
  b = parseFloat(b);
  result= (a + b)/coef; result = result.toFixed(2); 
  result = parseFloat(result);
  return(result)
}
