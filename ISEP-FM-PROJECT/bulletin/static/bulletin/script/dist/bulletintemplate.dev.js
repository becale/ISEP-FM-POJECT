...
window.addEventListener('load', function () {
  ...
  if (mydata[0] == 'GESTION') {
     ...
     */
    var GenerateBullMDS1Semestre1 = function GenerateBullMDS1Semestre1() {
      /**
       * HEADER
       */
      //title
      ...
      td5.setAttribute('id', 'MDS111-total');
      var td6 = document.createElement('td');
      td6.setAttribute('id', 'MDS111-moyenne'); //td6.setAttribute('rowspan','2')
    ...
    var GenerateBullStaps1Semestre1 = function GenerateBullStaps1Semestre1() {
      /**
       * HEADER
       */
      //title
