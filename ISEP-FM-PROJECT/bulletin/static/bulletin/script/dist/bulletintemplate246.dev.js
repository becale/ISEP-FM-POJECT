...
window.addEventListener('load', function () {
  ...
  if (mydata[0] == 'GESTION') {
    ...
    for (i = 0; i < mydata[1].length; i++) {
      ...
      clone = BullSTAPS2(clone, i); //Puis ajout au containerList
...
function BullMDS1(clone, i) {
  ...
  for (j = 0; j <= ligneMDS111.childElementCount - 1; j++) {
    ...
    if (j == 9) {
      if (listStudent[i][1][0] >= 7 && listStudent[i][1][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMDS111.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][1][0] >= 10) {
        ligneMDS111.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][1][0] < 10) {
        ligneMDS111.children[j].innerHTML = "NON VALIDEE";
      }
    } //Mention
  ...
  for (j = 0; j <= ligneMDS111b.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][2][0] >= 7 && listStudent[i][2][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMDS111b.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][2][0] >= 10) {
        ligneMDS111b.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][2][0] < 10) {
        ligneMDS111b.children[j].innerHTML = "NON VALIDEE";
      } //if (listStudent[i][2][5]) { ligneMDS111b.children[6].innerHTML = "VALIDEE" } else { ligneMDS111b.children[6].innerHTML = "NON VALIDEE" }
  ...
  for (j = 0; j <= ligneMDS112.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][3][0] >= 7 && listStudent[i][3][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMDS112.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][3][0] >= 10) {
        ligneMDS112.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][3][0] < 10) {
        ligneMDS112.children[j].innerHTML = "NON VALIDEE";
      } //if (listStudent[i][3][0] >= 20) { ligneMDS112.children[j].innerHTML = "VALIDEE" } else { ligneMDS112.children[j].innerHTML = "NON VALIDEE" } 
  ...
  for (j = 0; j <= ligneMDS112b.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][4][0] >= 7 && listStudent[i][4][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMDS112b.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][4][0] >= 10) {
        ligneMDS112b.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][3][0] < 10) {
        ligneMDS112b.children[j].innerHTML = "NON VALIDEE";
      } //if (listStudent[i][4][0] >= 10) { ligneMDS112b.children[j].innerHTML = "VALIDEE" } else { ligneMDS112b.children[j].innerHTML = "NON VALIDEE" } 
  ...
  for (j = 0; j <= ligneMDS113.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (listStudent[i][5][0] >= 7 && listStudent[i][5][0] < 10 && listStudent[i][5][3] >= 10) {
        ligneMDS113.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][3][0] >= 10) {
  ...
  for (j = 0; j <= ligneMDS114.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][6][0] >= 7 && listStudent[i][6][0] < 10 && listStudent[i][5][3] >= 10) {
        ligneMDS114.children[j].innerHTML = "MODULATION";
  ...
  for (j = 0; j <= ligneMDS115.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][7][0] >= 7 && listStudent[i][7][0] < 10 && listStudent[i][5][3] >= 10) {
        ligneMDS115.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][7][0] >= 10) {
        ligneMDS115.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][7][0] < 10) {
        ligneMDS115.children[j].innerHTML = "NON VALIDEE";
      } //if (listStudent[i][7][0] >= 10) { ligneMDS115.children[j].innerHTML = "VALIDEE" } else { ligneMDS115.children[j].innerHTML = "NON VALIDEE" }
  ...
  for (j = 0; j <= ligneMDS116.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][8][0] >= 7 && listStudent[i][8][0] < 10 && listStudent[i][5][3] >= 10) {
        ligneMDS116.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][8][0] >= 10) {
        ligneMDS116.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][8][0] < 10) {
        ligneMDS116.children[j].innerHTML = "NON VALIDEE";
      } //if (listStudent[i][8][0] >= 10) { ligneMDS116.children[j].innerHTML = "VALIDEE" } else { ligneMDS116.children[j].innerHTML = "NON VALIDEE" } 
  ...
  for (j = 0; j <= ligneMDS117.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (listStudent[i][9][0] >= 7 && listStudent[i][9][0] < 10 && listStudent[i][9][3] >= 10) {
        ligneMDS117.children[j].innerHTML = "MODULATION";
      ...
      //if (listStudent[i][9][0] >= 10) { ligneMDS117.children[j].innerHTML = "VALIDEE" } else { ligneMDS117.children[j].innerHTML = "NON VALIDEE" } 
  ...
  for (j = 0; j <= ligneMDS117b.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][10][0] >= 7 && listStudent[i][10][0] < 10 && listStudent[i][9][3] >= 10) {
        ligneMDS117b.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][10][0] >= 10) {
        ligneMDS117b.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][10][0] < 10) {
        ligneMDS117b.children[j].innerHTML = "NON VALIDEE";
      } //if (listStudent[i][10][0] >= 10) { ligneMDS117b.children[j].innerHTML = "VALIDEE" } else { ligneMDS117b.children[j].innerHTML = "NON VALIDEE" } 
  ...
  for (j = 0; j <= ligne11.childElementCount - 1; j++) {
    ...
    if (j == 9) {
      if (data[i][1][0] >= 7 && data[i][1][0] < 10 && data[i][1][3] >= 10) {
        ligne11.children[j].innerHTML = "MODULATION";
      } else if (data[i][1][0] >= 10) {
        ligne11.children[j].innerHTML = "VALIDEE";
      } else if (data[i][1][0] < 10) {
        ligne11.children[j].innerHTML = "NON VALIDEE";
      } //if (data[i][1][5]) { ligne11.children[j].innerHTML = "VALIDEE" } else { ligne11.children[j].innerHTML = "NON VALIDEE" }
  ...
  for (j = 0; j <= ligne22.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data[i][2][0] >= 7 && data[i][2][0] < 10 && data[i][1][3] >= 10) {
        ligne22.children[j].innerHTML = "MODULATION";
      } else if (data[i][2][0] >= 10) {
        ligne22.children[j].innerHTML = "VALIDEE";
      } else if (data[i][2][0] < 10) {
        ligne22.children[j].innerHTML = "NON VALIDEE";
      } //if (data[i][2][5]) { ligne22.children[j].innerHTML = "VALIDEE" } else { ligne22.children[j].innerHTML = "NON VALIDEE" } 
  ...
  for (j = 0; j <= ligne33.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data[i][3][0] >= 7 && data[i][3][0] < 10 && data[i][1][3] >= 10) {
        ligne33.children[j].innerHTML = "MODULATION";
      } else if (data[i][3][0] >= 10) {
        ligne33.children[j].innerHTML = "VALIDEE";
      } else if (data[i][3][0] < 10) {
        ligne33.children[j].innerHTML = "NON VALIDEE";
      } //if (data[i][3][5]) { ligne33.children[j].innerHTML = "VALIDEE" } else { ligne33.children[j].innerHTML = "NON VALIDEE" } 
  ...
  for (j = 0; j <= ligne44.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data[i][2][0] >= 7 && data[i][4][0] < 10 && data[i][1][3] >= 10) {
        ligne44.children[j].innerHTML = "MODULATION";
  ...
  for (j = 0; j <= ligne55.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (data[i][5][0] >= 7 && data[i][5][0] < 10 && data[i][5][3] >= 10) {
        ligne55.children[j].innerHTML = "MODULATION";
      } else if (data[i][5][0] >= 10) {
        ligne55.children[j].innerHTML = "VALIDEE";
      } else if (data[i][5][0] < 10) {
        ligne55.children[j].innerHTML = "NON VALIDEE";
      } //if (data[i][5][5]) { ligne55.children[j].innerHTML = "VALIDEE" } else { ligne55.children[j].innerHTML = "NON VALIDEE" } 
  ...
  for (j = 0; j <= ligne77.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data[i][7][0] >= 7 && data[i][7][0] < 10 && data[i][5][3] >= 10) {
        ligne77.children[j].innerHTML = "MODULATION";
  ...
  for (j = 0; j <= s2mdsResult.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      s2mdsResult.children[j].innerHTML = 'sommeInt()'; //(data[i][1][7] + data[i][3][7] + data[i][5][7] + data[i][6][7] + data[i][7][7] + data[i][8][7] + data[i][9][7] + data[i][10][7]) }
    }
    /**RESULTATS S1 & S2 MDS */
...
function BullSTAPS1(clone, i) {
  ...
  for (j = 0; j <= ligneEPS111.childElementCount - 1; j++) {
    ...
    if (j == 9) {
      if (listStudent[i][1][0] >= 7 && listStudent[i][1][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneEPS111.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][1][0] >= 10) {
        ligneEPS111.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][1][0] < 10) {
        ligneEPS111.children[j].innerHTML = "NON VALIDEE";
      }
    } //Mention
  ...
  for (j = 0; j <= ligneEPS112.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      ...
      if (listStudent[i][2][0] >= 7 && listStudent[i][2][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneEPS112.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][2][0] >= 10) {
        ligneEPS112.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][2][0] < 10) {
        ligneEPS112.children[j].innerHTML = "NON VALIDEE";
      }
    }
  ...
  for (j = 0; j <= ligneEPS113.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (listStudent[i][3][0] >= 7 && listStudent[i][3][0] < 10 && listStudent[i][3][3] >= 10) {
        ligneEPS113.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][2][0] >= 10) {
  ...
  for (j = 0; j <= ligneEPS114.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][4][0] >= 7 && listStudent[i][4][0] < 10 && listStudent[i][3][3] >= 10) {
        ligneEPS114.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][4][0] >= 10) {
  ...
  for (j = 0; j <= ligneEPS115a.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][5][0] >= 7 && listStudent[i][5][0] < 10 && listStudent[i][3][3] >= 10) {
        ligneEPS115a.children[j].innerHTML = "MODULATION";
  ...
  for (j = 0; j <= ligneEPS115b.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][6][0] >= 7 && listStudent[i][6][0] < 10 && listStudent[i][3][3] >= 10) {
        ligneEPS115b.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][6][0] >= 10) {
  ...
  for (j = 0; j <= ligneEPS115j.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][7][0] >= 7 && listStudent[i][7][0] < 10 && listStudent[i][3][3] >= 10) {
        ligneEPS115j.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][7][0] >= 10) {
        ligneEPS115j.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][7][0] < 10) {
        ligneEPS115j.children[j].innerHTML = "NON VALIDEE";
      } //if (listStudent[i][7][5]) { ligneEPS115j.children[j].innerHTML = "VALIDEE" } else { ligneEPS115j.children[j].innerHTML = "NON VALIDEE" } 
  ...
  for (j = 0; j <= ligneEPS115l.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][8][0] >= 7 && listStudent[i][8][0] < 10 && listStudent[i][3][3] >= 10) {
        ligneEPS115l.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][8][0] >= 10) {
        ligneEPS115l.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][8][0] < 10) {
        ligneEPS115l.children[j].innerHTML = "NON VALIDEE";
      } //if (listStudent[i][8][5]) { ligneEPS115l.children[j].innerHTML = "VALIDEE" } else { ligneEPS115l.children[j].innerHTML = "NON VALIDEE" } 
  ...
  for (j = 0; j <= ligneEPS116.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][8][0] >= 7 && listStudent[i][9][0] < 10 && listStudent[i][3][3] >= 10) {
        ligneEPS116.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][9][0] >= 10) {
  ...
  for (j = 0; j <= ligneEPS117.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (listStudent[i][10][0] >= 7 && listStudent[i][10][0] < 10 && listStudent[i][10][3] >= 10) {
        ligneEPS117.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][10][0] >= 10) {
  ...
  for (j = 0; j <= ligneEPS118.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][11][0] >= 7 && listStudent[i][11][0] < 10 && listStudent[i][10][3] >= 10) {
        ligneEPS118.children[j].innerHTML = "MODULATION";
  ...
  for (j = 0; j <= ligneEPS119.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      //if (listStudent[i][12][5]) { ligneEPS119.children[j].innerHTML = "VALIDEE" } else { ligneEPS119.children[j].innerHTML = "NON VALIDEE" } 
      if (listStudent[i][12][0] >= 7 && listStudent[i][12][0] < 10 && listStudent[i][10][3] >= 10) {
        ligneEPS119.children[j].innerHTML = "MODULATION";
  ...
  for (j = 0; j <= ligne11.childElementCount - 1; j++) {
    ...
    if (j == 9) {
      //if (data2[i][1][5]) { ligne11.children[j].innerHTML = "VALIDEE" } else { ligne11.children[j].innerHTML = "NON VALIDEE" }
  ...
  for (j = 0; j <= ligne22.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data2[i][2][0] >= 7 && data2[i][2][0] < 10 && data2[i][1][3] >= 10) {
        ...
        ligne22.children[j].innerHTML = "NON VALIDEE";
      } //if (data2[i][2][5]) { ligne22.children[j].innerHTML = "VALIDEE" } else { ligne22.children[j].innerHTML = "NON VALIDEE" } 
  ...
  for (j = 0; j <= ligne66.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data2[i][6][0] >= 7 && data2[i][6][0] < 10 && data2[i][3][3] >= 10) {
        ligne66.children[j].innerHTML = "MODULATION";
  ...
  for (j = 0; j <= ligne88.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data2[i][8][0] >= 7 && data2[i][8][0] < 10 && data2[i][3][3] >= 10) {
        ligne88.children[j].innerHTML = "MODULATION";
  ...
  for (j = 0; j <= ligne99.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data2[i][9][0] >= 7 && data2[i][9][0] < 10 && data2[i][3][3] >= 10) {
        ligne99.children[j].innerHTML = "MODULATION";
  ...
  for (j = 0; j <= ligne100.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (data2[i][10][0] >= 7 && data2[i][10][0] < 10 && data2[i][10][3] >= 10) {
        ligne100.children[j].innerHTML = "MODULATION";
  ...
  for (j = 0; j <= ligne111.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data2[i][11][0] >= 7 && data2[i][11][0] < 10 && data2[i][10][3] >= 10) {
        ligne111.children[j].innerHTML = "MODULATION";
  ...
  for (j = 0; j <= ligne112.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data2[i][2][0] >= 7 && data2[i][12][0] < 10 && data2[i][10][3] >= 10) {
        ligne112.children[j].innerHTML = "MODULATION";
      } else if (data2[i][12][0] >= 10) {
        ligne112.children[j].innerHTML = "VALIDEE";
      } else if (data2[i][12][0] < 10) {
        ligne112.children[j].innerHTML = "NON VALIDEE";
      }
    }
...
function BullSTAPS2(clone, i) {
  ...
  for (j = 0; j <= ligneEPS115f.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][7][5]) {
        ligneEPS115f.children[j].innerHTML = "VALIDEE";
      } else {
        ligneEPS115f.children[j].innerHTML = "NON VALIDEE";
      }
    } //Mention
    ...
    if (j == 8) {
      if (listStudent[i][7][5]) {
        ligneEPS115f.children[j].innerHTML = listStudent[i][7][6];
      } else {
        ligneEPS115f.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS115g.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][8][5]) {
        ligneEPS115g.children[j].innerHTML = "VALIDEE";
      } else {
        ligneEPS115g.children[j].innerHTML = "NON VALIDEE";
      }
    } //Mention
    ...
    if (j == 8) {
      if (listStudent[i][8][5]) {
        ligneEPS115g.children[j].innerHTML = listStudent[i][8][6];
      } else {
        ligneEPS115g.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS115l.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (listStudent[i][10][5]) {
        ligneEPS115l.children[j].innerHTML = listStudent[i][10][6];
      } else {
        ligneEPS115l.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS116.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (listStudent[i][11][5]) {
        ligneEPS116.children[j].innerHTML = listStudent[i][11][6];
      } else {
        ligneEPS116.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS117.childElementCount - 1; j++) {
    ...
    if (j == 10) {
      if (listStudent[i][12][5]) {
        ligneEPS117.children[j].innerHTML = listStudent[i][12][6];
      } else {
        ligneEPS117.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS118.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (listStudent[i][13][5]) {
        ligneEPS118.children[j].innerHTML = listStudent[i][13][6];
      } else {
        ligneEPS118.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS119.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (listStudent[i][14][5]) {
        ligneEPS119.children[j].innerHTML = listStudent[i][14][6];
      } else {
        ligneEPS119.children[j].innerHTML = 0;
      }
    } //nombre_crédits
...
function BullEVE(clone, i) {
  ...
  for (j = 0; j <= ligneMAS315.childElementCount - 1; j++) {
    ...
    if (j == 9) {
      if (listStudent[i][1][0] >= 7 && listStudent[i][1][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMAS315.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][1][0] >= 10) {
        ligneMAS315.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][1][0] < 10) {
        ligneMAS315.children[j].innerHTML = "NON VALIDEE";
      }
    } //Mention
  ...
  for (j = 0; j <= ligneMAS325.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][2][0] >= 7 && listStudent[i][2][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMAS325.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][2][0] >= 10) {
        ligneMAS325.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][2][0] < 10) {
        ligneMAS325.children[j].innerHTML = "NON VALIDEE";
      }
    }
  ...
  for (j = 0; j <= ligneMAS335.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      //if (listStudent[i][3][0] >= 10) { ligneMAS335.children[j].innerHTML = "VALIDEE" } else { ligneMAS335.children[j].innerHTML = "NON VALIDEE" } 
      if (listStudent[i][3][0] >= 7 && listStudent[i][3][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMAS335.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][3][0] >= 10) {
        ligneMAS335.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][3][0] < 10) {
        ligneMAS335.children[j].innerHTML = "NON VALIDEE";
      }
    } //Mention
  ...
  for (j = 0; j <= ligneMAS345.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      //if (listStudent[i][4][0] >= 10) { ligneMAS345.children[j].innerHTML = "VALIDEE" } else { ligneMAS345.children[j].innerHTML = "NON VALIDEE" } 
      if (listStudent[i][4][0] >= 7 && listStudent[i][4][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMAS345.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][4][0] >= 10) {
        ligneMAS345.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][4][0] < 10) {
        ligneMAS345.children[j].innerHTML = "NON VALIDEE";
      }
    } //Mention
  ...
  for (j = 0; j <= ligneMAS355.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (listStudent[i][5][0] >= 7 && listStudent[i][5][0] < 10 && listStudent[i][5][3] >= 10) {
        ligneMAS355.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][5][0] >= 10) {
        ligneMAS355.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][5][0] < 10) {
        ligneMAS355.children[j].innerHTML = "NON VALIDEE";
      }
    } //Mention
  ...
  for (j = 0; j <= ligneMAS365.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][6][0] >= 7 && listStudent[i][6][0] < 10 && listStudent[i][5][3] >= 10) {
        ligneMAS365.children[j].innerHTML = "MODULATION";
      } else if (listStudent[i][6][0] >= 10) {
        ligneMAS365.children[j].innerHTML = "VALIDEE";
      } else if (listStudent[i][6][0] < 10) {
        ligneMAS365.children[j].innerHTML = "NON VALIDEE";
      }
    } //Mention
  ...
  for (j = 0; j <= ligneMAS316.childElementCount - 1; j++) {
    ...
    if (j == 9) {
      if (semestre6[i][1][0] >= 7 && semestre6[i][1][0] < 10 && semestre6[i][1][3] >= 10) {
        ligneMAS316.children[j].innerHTML = "MODULATION";
      } else if (semestre6[i][1][0] >= 10) {
        ligneMAS316.children[j].innerHTML = "VALIDEE";
      } else if (semestre6[i][1][0] < 7) {
        ligneMAS316.children[j].innerHTML = "NON VALIDEE";
      }
      /*if (semestre6[i][1][5]) {
          ligneMAS316.children[9].innerHTML = "VALIDEE"
      } else { ligneMAS316.children[9].innerHTML = "NON VALIDEE" }*/
  ...
  for (j = 0; j <= ligneMAS326.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (semestre6[i][2][0] >= 7 && semestre6[i][2][0] < 10 && semestre6[i][1][3] >= 10) {
        ligneMAS326.children[j].innerHTML = "MODULATION";
      } else if (semestre6[i][2][0] >= 10) {
        ligneMAS326.children[j].innerHTML = "VALIDEE";
      } else
        /*if ( /*semestre6[i][2][0] < 7 || semestre6[i][2][0] < 10)*/
        {
          ligneMAS326.children[j].innerHTML = "NON VALIDEE";
        } //if (semestre6[i][2][5]) { ligneMAS326.children[6].innerHTML = "VALIDEE" } else { ligneMAS326.children[6].innerHTML = "NON VALIDEE" }
  ...
  for (j = 0; j <= ligneMAS336.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (semestre6[i][3][0] >= 7 && semestre6[i][3][0] < 10 && semestre6[i][1][3] >= 10) {
        ligneMAS336.children[j].innerHTML = "MODULATION";
      } else if (semestre6[i][3][0] >= 10) {
        ligneMAS336.children[j].innerHTML = "VALIDEE";
      } else if (semestre6[i][3][0] < 7) {
        ligneMAS336.children[j].innerHTML = "NON VALIDEE";
      }
    } //Mention
  ...
  for (j = 0; j <= ligneMAS346.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (semestre6[i][4][0] >= 7 && semestre6[i][4][0] < 10 && semestre6[i][1][3] >= 10) {
        ligneMAS346.children[j].innerHTML = "MODULATION";
      } else if (semestre6[i][4][0] >= 10) {
        ligneMAS346.children[j].innerHTML = "VALIDEE";
      } else if (semestre6[i][4][0] < 7) {
        ligneMAS346.children[j].innerHTML = "NON VALIDEE";
      }
    } //Mention
  ...
  for (j = 0; j <= ligneEVE356.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ...
      if (semestre6[i][5][0] >= 7 && semestre6[i][5][0] < 10 && semestre6[i][5][3] >= 10) {
        ligneEVE356.children[j].innerHTML = "MODULATION";
      } else if (semestre6[i][5][0] >= 10) {
        ligneEVE356.children[j].innerHTML = "VALIDEE";
      } else if (semestre6[i][5][0] < 10) {
        ligneEVE356.children[j].innerHTML = "NON VALIDEE";
      }
    } //Mention
  ...
  for (j = 0; j <= ligneEVE366.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (semestre6[i][6][0] >= 7 && semestre6[i][6][0] < 10 && semestre6[i][5][3] >= 10) {
        ligneEVE366.children[j].innerHTML = "MODULATION";
      } else if (semestre6[i][6][0] >= 10) {
        ligneEVE366.children[j].innerHTML = "VALIDEE";
      } else
        /*if (semestre6[i][6][0] < 7)*/
        {
          ligneEVE366.children[j].innerHTML = "NON VALIDEE";
        }
    } //Mention
