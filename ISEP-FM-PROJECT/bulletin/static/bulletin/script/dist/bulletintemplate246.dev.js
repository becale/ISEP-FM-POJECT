...
window.addEventListener('load', function () {
  ...
  if (mydata[0] == 'GESTION') {
    ...
    for (i = 0; i < mydata[1].length; i++) {
      ...
      clone = BullSTAPS1(clone, i, mydata); //Puis ajout au containerList
    ...
    for (var i = 0; i < mydata[1].length; i++) {
      var clone = containeer.cloneNode(true); //Execution des traitements sur container

      clone = BullSTAPS2(clone, i, mydata); //Puis ajout au containerList
    ...
    for (i = 0; i < mydata[1].length; i++) {
      ...
      clone = BullEVE(clone, i); //Puis ajout au containerList
...
function GenerateBullStaps2Semestre3() {
  ...
  for (var _i = 0; _i < thvalue.length; _i++) {
    var th = document.createElement('th');
    th.setAttribute("scope", "col");
    th.innerHTML = thvalue[_i];
    tr1.appendChild(th);
  }
  ...
  var td53 = document.createElement('td'); //td53.setAttribute('rowspan','2')
  ...
  newNode.setAttribute('id', 'ligne-eps250'); //newNode.children[1].innerHTML = "PEDAGOGIE PRATIQUE III"
  ...
  node248.insertBefore(tdcredit, node248.lastChild); //node 247
  ...
  node247.insertBefore(tdcredit1, node247.lastChild); //node 246
...
function BullMDS1(clone, i, mydata) {
  ...
  listStudent = mydata[1]; //semestre1 =
  //Info Utilisateur
  ...
  info2.children[4].innerHTML = info2.children[4].innerHTML + " 2022-2023"; //Tableau de notes
  ...
  for (j = 0; j <= ligneMDS111.childElementCount - 1; j++) {
    ...
    if (j == 9) {
      if (listStudent[i][1][0] >= 7 && listStudent[i][1][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMDS111.children[j].innerHTML = "Validée";
      } else if (listStudent[i][1][0] >= 10) {
        ligneMDS111.children[j].innerHTML = "Validée";
      } else if (listStudent[i][1][0] < 10) {
        ligneMDS111.children[j].innerHTML = "Non validée";
      }
    } //Mention
    ...
    if (j == 11) {
      if (listStudent[i][1][0] >= 7 && listStudent[i][1][3] >= 10 || listStudent[i][1][0] >= 10) {
  ...
  for (j = 0; j <= ligneMDS111b.childElementCount - 1; j++) {
    ...
    if (j == 4) {
      ...
      ligneMDS111b.children[j].innerHTML = listStudent[i][2][2];
    } //total note math * coef


    if (j == 5) {
      ligneMDS111b.children[j].innerHTML = listStudent[i][2][4];
    } //Rang


    if (j == 6) {
      if (listStudent[i][2][0] >= 7 && listStudent[i][2][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMDS111b.children[j].innerHTML = "Validée";
      } else if (listStudent[i][2][0] >= 10) {
        ligneMDS111b.children[j].innerHTML = "Validée";
      } else if (listStudent[i][2][0] < 10) {
        ligneMDS111b.children[j].innerHTML = "Non validée";
    ...
    if (j == 8) {
      if (listStudent[i][2][0] >= 7 && listStudent[i][1][3] >= 10 || listStudent[i][2][0] >= 10) {
  ...
  for (j = 0; j <= ligneMDS112.childElementCount - 1; j++) {
    if (j == 2) {
      ligneMDS112.children[j].innerHTML = listStudent[i][3][0];
    } //note info


    if (j == 3) {
      ligneMDS112.children[j].innerHTML = listStudent[i][3][1];
    } //coef info


    if (j == 4) {
      /*val=ligneMDS112.children[2].innerHTML*ligneMDS112.children[3].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      ligneMDS112.children[j].innerHTML = listStudent[i][3][2];
    } //total note math * coef


    if (j == 5) {
      ligneMDS112.children[j].innerHTML = listStudent[i][3][4];
    } //Rang


    if (j == 6) {
      if (listStudent[i][3][0] >= 7 && listStudent[i][3][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMDS112.children[j].innerHTML = "Validée";
      } else if (listStudent[i][3][0] >= 10) {
        ligneMDS112.children[j].innerHTML = "Validée";
      } else if (listStudent[i][3][0] < 10) {
        ligneMDS112.children[j].innerHTML = "Non validée";
    ...
    if (j == 8) {
      if (listStudent[i][3][0] >= 7 && listStudent[i][1][3] >= 10 || listStudent[i][4][0] >= 7 && listStudent[i][1][3] >= 10 || listStudent[i][3][0] >= 10 || listStudent[i][4][0] >= 10) {
        ligneMDS112.children[j].innerHTML = listStudent[i][3][6];
      } else {
  ...
  for (j = 0; j <= ligneMDS112b.childElementCount - 1; j++) {
    if (j == 2) {
      ligneMDS112b.children[j].innerHTML = listStudent[i][4][0];
    } //note info


    if (j == 3) {
      ligneMDS112b.children[j].innerHTML = listStudent[i][4][1];
    } //coef info


    if (j == 4) {
      /*val=ligneMDS112b.children[2].innerHTML*ligneMDS112b.children[3].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      ligneMDS112b.children[j].innerHTML = listStudent[i][4][2];
    } //total note math * coef


    if (j == 5) {
      ligneMDS112b.children[j].innerHTML = listStudent[i][4][4];
    } //Rang


    if (j == 6) {
      if (listStudent[i][4][0] >= 7 && listStudent[i][4][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMDS112b.children[j].innerHTML = "Validée";
      } else if (listStudent[i][4][0] >= 10) {
        ligneMDS112b.children[j].innerHTML = "Validée";
      } else if (listStudent[i][3][0] < 10) {
        ligneMDS112b.children[j].innerHTML = "Non validée";
  ...
  for (j = 0; j <= ligneMDS113.childElementCount - 1; j++) {
    if (j == 3) {
      ligneMDS113.children[j].innerHTML = listStudent[i][5][0];
    } //note math


    if (j == 4) {
      ligneMDS113.children[j].innerHTML = listStudent[i][5][1];
    } //coef math


    if (j == 5) {
      /*val=ligneMDS113.children[3].innerHTML*ligneMDS113.children[4].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      ligneMDS113.children[j].innerHTML = listStudent[i][5][2];
    } //total note math * coef
    ...
    if (j == 7) {
      ligneMDS113.children[j].innerHTML = listStudent[i][5][4];
    } //Rang


    if (j == 8) {
      if (listStudent[i][5][0] >= 7 && listStudent[i][5][0] < 10 && listStudent[i][5][3] >= 10) {
        ligneMDS113.children[j].innerHTML = "Validée";
      } else if (listStudent[i][3][0] >= 10) {
        ligneMDS113.children[j].innerHTML = "Validée";
      } else if (listStudent[i][3][0] < 10) {
        ligneMDS113.children[j].innerHTML = "Non validée";
      }
    ...
    if (j == 10) {
      if (listStudent[i][5][0] >= 7 && listStudent[i][5][3] >= 10 || listStudent[i][5][0] >= 10) {
        ligneMDS113.children[j].innerHTML = listStudent[i][5][6];
      } else {
  ...
  for (j = 0; j <= ligneMDS114.childElementCount - 1; j++) {
    if (j == 2) {
      ligneMDS114.children[j].innerHTML = listStudent[i][6][0];
    } //note info


    if (j == 3) {
      ligneMDS114.children[j].innerHTML = listStudent[i][6][1];
    } //coef info


    if (j == 4) {
      /*val=ligneMDS114.children[2].innerHTML*ligneMDS114.children[3].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      ligneMDS114.children[j].innerHTML = listStudent[i][6][2];
    } //total note math * coef


    if (j == 5) {
      ligneMDS114.children[j].innerHTML = listStudent[i][6][4];
    } //Rang


    if (j == 6) {
      if (listStudent[i][6][0] >= 7 && listStudent[i][6][0] < 10 && listStudent[i][5][3] >= 10) {
        ligneMDS114.children[j].innerHTML = "Validée";
      } else if (listStudent[i][6][0] >= 10) {
        ligneMDS114.children[j].innerHTML = "Validée";
      } else if (listStudent[i][6][0] < 10) {
        ligneMDS114.children[j].innerHTML = "Non validée";
      }
    } //Mention
    ...
    if (j == 8) {
      if (listStudent[i][6][0] >= 7 && listStudent[i][5][3] >= 10 || listStudent[i][6][0] >= 10) {
        ligneMDS114.children[j].innerHTML = listStudent[i][6][6];
      } else {
  ...
  for (j = 0; j <= ligneMDS115.childElementCount - 1; j++) {
    if (j == 2) {
      ligneMDS115.children[j].innerHTML = listStudent[i][7][0];
    } //note info


    if (j == 3) {
      ligneMDS115.children[j].innerHTML = listStudent[i][7][1];
    } //coef info


    if (j == 4) {
      /*val=ligneMDS115.children[2].innerHTML*ligneMDS115.children[3].innerHTML; val=val.toFixed(2);val=parseFloat(val);*/
      ligneMDS115.children[j].innerHTML = listStudent[i][7][2];
    } //total note math * coef


    if (j == 5) {
      ligneMDS115.children[j].innerHTML = listStudent[i][7][4];
    } //Rang


    if (j == 6) {
      if (listStudent[i][7][0] >= 7 && listStudent[i][7][0] < 10 && listStudent[i][5][3] >= 10) {
        ligneMDS115.children[j].innerHTML = "Validée";
      } else if (listStudent[i][7][0] >= 10) {
        ligneMDS115.children[j].innerHTML = "Validée";
      } else if (listStudent[i][7][0] < 10) {
        ligneMDS115.children[j].innerHTML = "Non validée";
    ...
    if (j == 8) {
      if (listStudent[i][7][0] >= 7 && listStudent[i][5][3] >= 10 || listStudent[i][7][0] >= 10) {
        ligneMDS115.children[j].innerHTML = listStudent[i][7][6];
      } else {
  ...
  for (j = 0; j <= ligneMDS116.childElementCount - 1; j++) {
    if (j == 2) {
      ligneMDS116.children[j].innerHTML = listStudent[i][8][0];
    } //note info


    if (j == 3) {
      ligneMDS116.children[j].innerHTML = listStudent[i][8][1];
    } //coef info


    if (j == 4) {
      /*val=ligneMDS116.children[2].innerHTML*ligneMDS116.children[3].innerHTML;val=val.toFixed(2);val=parseFloat(val);*/
      ligneMDS116.children[j].innerHTML = listStudent[i][8][2];
    } //total note math * coef


    if (j == 5) {
      ligneMDS116.children[j].innerHTML = listStudent[i][8][4];
    } //Rang


    if (j == 6) {
      if (listStudent[i][8][0] >= 7 && listStudent[i][8][0] < 10 && listStudent[i][5][3] >= 10) {
        ligneMDS116.children[j].innerHTML = "Validée";
      } else if (listStudent[i][8][0] >= 10) {
        ligneMDS116.children[j].innerHTML = "Validée";
      } else if (listStudent[i][8][0] < 10) {
        ligneMDS116.children[j].innerHTML = "Non validée";
    ...
    if (j == 8) {
      if (listStudent[i][8][0] >= 7 && listStudent[i][5][3] >= 10 || listStudent[i][8][0] >= 10) {
        ligneMDS116.children[j].innerHTML = listStudent[i][8][6];
      } else {
  ...
  for (j = 0; j <= ligneMDS117.childElementCount - 1; j++) {
    if (j == 3) {
      ligneMDS117.children[j].innerHTML = listStudent[i][9][0];
    } //note math


    if (j == 4) {
      ligneMDS117.children[j].innerHTML = listStudent[i][9][1];
    } //coef math


    if (j == 5) {
      /*val=ligneMDS117.children[3].innerHTML*ligneMDS117.children[4].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      ligneMDS117.children[j].innerHTML = listStudent[i][9][2];
    } //total note math * coef
    ...
    if (j == 7) {
      ligneMDS117.children[j].innerHTML = listStudent[i][9][4];
    } //Rang


    if (j == 8) {
      if (listStudent[i][9][0] >= 7 && listStudent[i][9][0] < 10 && listStudent[i][9][3] >= 10) {
        ligneMDS117.children[j].innerHTML = "Validée";
      } else if (listStudent[i][9][0] >= 10) {
        ligneMDS117.children[j].innerHTML = "Validée";
      } else if (listStudent[i][9][0] < 10) {
        ligneMDS117.children[j].innerHTML = "Non validée";
    ...
    if (j == 10) {
      if (listStudent[i][9][0] >= 7 && listStudent[i][9][3] >= 10 || listStudent[i][9][0] >= 10) {
        ligneMDS117.children[j].innerHTML = listStudent[i][9][6];
      } else {
  ...
  for (j = 0; j <= ligneMDS117b.childElementCount - 1; j++) {
    if (j == 2) {
      ligneMDS117b.children[j].innerHTML = listStudent[i][10][0];
    } //note math


    if (j == 3) {
      ligneMDS117b.children[j].innerHTML = listStudent[i][10][1];
    } //coef math
    ...
    if (j == 5) {
      ligneMDS117b.children[j].innerHTML = listStudent[i][10][4];
    } //Rang


    if (j == 6) {
      if (listStudent[i][10][0] >= 7 && listStudent[i][10][0] < 10 && listStudent[i][9][3] >= 10) {
        ligneMDS117b.children[j].innerHTML = "Validée";
      } else if (listStudent[i][10][0] >= 10) {
        ligneMDS117b.children[j].innerHTML = "Validée";
      } else if (listStudent[i][10][0] < 10) {
        ligneMDS117b.children[j].innerHTML = "Non validée";
    ...
    if (j == 8) {
      if (listStudent[i][10][0] >= 7 && listStudent[i][9][3] >= 10 || listStudent[i][10][0] >= 10) {
        ligneMDS117b.children[j].innerHTML = listStudent[i][10][6];
      } else {
        ligneMDS117b.children[j].innerHTML = 0;
      }
    } //Credit
  ...
  for (j = 0; j <= resultat.childElementCount - 1; j++) {
    ...
    if (j == 2) {
      resultat.children[2].innerHTML = listStudent[i][11][1];
    }
    /*sommeFloat(ligneMDS111b.children[4].innerHTML, ligneMDS111.children[6].innerHTML, ligneMDS112.children[4].innerHTML, ligneMDS113.children[5].innerHTML, ligneMDS114.children[4].innerHTML, ligneMDS115.children[4].innerHTML,ligneMDS116.children[4].innerHTML, ligneMDS117.children[5].innerHTML, ligneMDS112b.children[4].innerHTML, ligneMDS117b.children[4].innerHTML) }*/


    if (j == 3) {
      /*val = resultat.children[2].innerHTML / resultat.children[1].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      resultat.children[j].innerHTML = listStudent[i][11][2];
    }

    if (j == 4) {
      resultat.children[j].innerHTML = mydata[2].indexOf(listStudent[i][11][2]) + 1;
      /** "SDF" */
    }

    if (j == 6) {
      resultat.children[j].innerHTML = sommeIntmds(ligneMDS111.children[11].innerHTML, ligneMDS112.children[8].innerHTML, ligneMDS113.children[10].innerHTML, ligneMDS114.children[8].innerHTML, ligneMDS115.children[8].innerHTML, ligneMDS116.children[8].innerHTML, ligneMDS117.children[10].innerHTML, ligneMDS117b.children[8].innerHTML);
    }
    /**TOtal Crédit */
  ...
  for (j = 0; j <= ligne1.childElementCount - 1; j++) {
    if (j == 5) {
      ligne2.children[j].innerHTML = "".concat(mydata[2].indexOf(listStudent[i][11][2]) + 1, " sur ").concat(mydata[1].length);
    }
  ...
  for (j = 0; j <= ligne11.childElementCount - 1; j++) {
    ...
    if (j == 9) {
      if (data[i][1][0] >= 7 && data[i][1][0] < 10 && data[i][1][3] >= 10) {
        ligne11.children[j].innerHTML = "Validée";
      } else if (data[i][1][0] >= 10) {
        ligne11.children[j].innerHTML = "Validée";
      } else if (data[i][1][0] < 10) {
  ...
  for (j = 0; j <= ligne22.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data[i][2][0] >= 7 && data[i][2][0] < 10 && data[i][1][3] >= 10) {
        ligne22.children[j].innerHTML = "Validée";
      } else if (data[i][2][0] >= 10) {
        ligne22.children[j].innerHTML = "Validée";
      } else if (data[i][2][0] < 10) {
  ...
  for (j = 0; j <= ligne33.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data[i][3][0] >= 7 && data[i][3][0] < 10 && data[i][1][3] >= 10) {
        ligne33.children[j].innerHTML = "Validée";
      } else if (data[i][3][0] >= 10) {
        ligne33.children[j].innerHTML = "Validée";
      } else if (data[i][3][0] < 10) {
  ...
  for (j = 0; j <= ligne44.childElementCount - 1; j++) {
    ...
    if (j == 5) {
      ligne44.children[j].innerHTML = data[i][3][4];
    }

    if (j == 6) {
      if (data[i][2][0] >= 7 && data[i][4][0] < 10 && data[i][1][3] >= 10) {
        ligne44.children[j].innerHTML = "Validée";
      } else if (data[i][4][0] >= 10) {
        ligne44.children[j].innerHTML = "Validée";
      } else if (data[i][4][0] < 10) {
  ...
  for (j = 0; j <= ligne55.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (data[i][5][0] >= 7 && data[i][5][0] < 10 && data[i][5][3] >= 10) {
        ligne55.children[j].innerHTML = "Validée";
      } else if (data[i][5][0] >= 10) {
        ligne55.children[j].innerHTML = "Validée";
      } else if (data[i][5][0] < 10) {
    ...
    if (j == 10) {
      if (data[i][5][0] >= 7 && data[i][5][3] >= 10 || data[i][5][0] >= 10) {
        ligne55.children[j].innerHTML = data[i][5][6];
      } else {
  ...
  for (j = 0; j <= ligne66.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (data[i][6][0] >= 7 && data[i][5][3] >= 10 || data[i][6][0] >= 10) {
        ligne66.children[j].innerHTML = data[i][6][6];
      } else {
  ...
  for (j = 0; j <= ligne77.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (data[i][7][0] >= 7 && data[i][7][0] < 10 && data[i][5][3] >= 10) {
        ligne77.children[j].innerHTML = "Validée";
      } else if (data[i][7][0] >= 10) {
        ligne77.children[j].innerHTML = "Validée";
      } else if (data[i][7][0] < 10) {
    ...
    if (j == 8) {
      if (data[i][7][0] >= 7 && data[i][5][3] >= 10 || data[i][7][0] >= 10) {
        ligne77.children[j].innerHTML = data[i][7][6];
      } else {
...
function BullSTAPS1(clone, i, mydata) {
  ...
  for (j = 0; j <= ligne11.childElementCount - 1; j++) {
    ...
    if (j == 11) {
      ligne11.children[j].innerHTML = data2[i][1][7]; //if ((data2[i][1][0] >= 7 && data2[i][1][3] >= 10) || (data2[i][1][0] >= 10)) { ligne11.children[j].innerHTML = data2[i][1][6] } else { ligne11.children[j].innerHTML = 0 }
    }
  } //Ligne 2
  ...
  for (j = 0; j <= ligne22.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ligne22.children[j].innerHTML = data2[i][2][7]; //if ((data2[i][2][0] >= 7 && data2[i][1][3] >= 10) || (data2[i][2][0] >= 10)) { ligne22.children[j].innerHTML = data2[i][2][6] } else { ligne22.children[j].innerHTML = 0 }
  ...
  for (j = 0; j <= ligne33.childElementCount - 1; j++) {
    ...
    if (j == 10) {
      ligne33.children[j].innerHTML = data2[i][3][7]; //if ((data2[i][3][0] >= 7 && data2[i][3][3] >= 10) || (data2[i][2][0] >= 10)) { ligne33.children[j].innerHTML = data2[i][3][6] } else { ligne33.children[j].innerHTML = 0 }
  ...
  for (j = 0; j <= ligne44.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ligne44.children[j].innerHTML = data2[i][4][7]; //if ((data2[i][4][0] >= 7 && data2[i][3][3] >= 10) || (data2[i][4][0] >= 10)) { ligne44.children[j].innerHTML = data2[i][4][6] } else { ligne44.children[j].innerHTML = 0 }
    }
  } //Ligne 5
  ...
  for (j = 0; j <= ligne55.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ligne55.children[j].innerHTML = data2[i][5][7]; //if ((data2[i][5][0] >= 7 && data2[i][3][3] >= 10) || (data2[i][5][0] >= 10)) { ligne55.children[j].innerHTML = data2[i][5][6] } else { ligne55.children[j].innerHTML = 0 }
  ...
  for (j = 0; j <= ligne66.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ligne66.children[j].innerHTML = data2[i][6][7]; //if ((data2[i][6][0] >= 7 && data2[i][3][3] >= 10) || (data2[i][6][0] >= 10)) { ligne66.children[j].innerHTML = data2[i][6][6] } else { ligne66.children[j].innerHTML = 0 }
    }
  } //Ligne 7
  ...
  for (j = 0; j <= ligne77.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ligne77.children[j].innerHTML = data2[i][7][7]; //if ((data2[i][7][0] >= 7 && data2[i][3][3] >= 10) || (data2[i][7][0] >= 10)) { ligne77.children[j].innerHTML = data2[i][7][6] } else { ligne77.children[j].innerHTML = 0 }
    }
  } //Ligne 8
  ...
  for (j = 0; j <= ligne88.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ligne88.children[j].innerHTML = data2[i][8][7]; //if ((data2[i][8][0] >= 7 && data2[i][3][3] >= 10) || (data2[i][8][0] >= 10)) { ligne88.children[j].innerHTML = data2[i][8][6] } else { ligne88.children[j].innerHTML = 0 }
    }
  } //Ligne 9
  ...
  for (j = 0; j <= ligne99.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ligne99.children[j].innerHTML = data2[i][9][7]; //if ((data2[i][9][0] >= 7 && data2[i][3][3] >= 10) || (data2[i][9][0] >= 10)) { ligne99.children[j].innerHTML = data2[i][9][6] } else { ligne99.children[j].innerHTML = 0 }
    }
  } //Ligne 10
  ...
  for (j = 0; j <= ligne100.childElementCount - 1; j++) {
    ...
    if (j == 10) {
      ligne100.children[j].innerHTML = data2[i][10][7]; //if ((data2[i][10][0] >= 7 && data2[i][10][3] >= 10) || (data2[i][10][0] >= 10)) { ligne100.children[j].innerHTML = data2[i][10][6] } else { ligne100.children[j].innerHTML = 0 }
    } //else { ligne11.children[j].innerHTML = 0,  + data2[i][2][0]) >= 20 
  ...
  for (j = 0; j <= ligne111.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ligne111.children[j].innerHTML = data2[i][11][7]; //if ((data2[i][11][0] >= 7 && data2[i][10][3] >= 10) || (data2[i][11][0] >= 10)) { ligne111.children[j].innerHTML = data2[i][11][6] } else { ligne111.children[j].innerHTML = 0 }
    } //else { ligne11.children[j].innerHTML = 0,  + data2[i][2][0]) >= 20 
  ...
  for (j = 0; j <= ligne112.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ...
      ligne112.children[j].innerHTML = data2[i][12][7]; //if ((data2[i][12][0] >= 7 && data2[i][10][3] >= 10) || (data2[i][12][0] >= 10)) { ligne112.children[j].innerHTML = data2[i][11][6] } else { ligne112.children[j].innerHTML = 0 }
    } //else { ligne11.children[j].innerHTML = 0,  + data2[i][2][0]) >= 20
...
function BullSTAPS2(clone, i, mydata) {
  //DONNEES RECUPEREES DE LA BD
  var listStudent = mydata[1]; //Info Utilisateur
  ...
  for (var j = 0; j <= ligneEPS111.childElementCount - 1; j++) {
    ...
    if (j == 11) {
      ligneEPS111.children[j].innerHTML = listStudent[i][1][7]; //if (listStudent[i][1][0] >= 10) { ligneEPS111.children[j].innerHTML = listStudent[i][1][6] } else { ligneEPS111.children[j].innerHTML = 0 } 
  ...
  for (j = 0; j <= ligneEPS112.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ligneEPS112.children[j].innerHTML = listStudent[i][2][7]; //if ((listStudent[i][2][0] >= 7 && listStudent[i][1][2] >= 10) || (listStudent[i][1][0] >= 10)) { ligneEPS112.children[j].innerHTML = listStudent[i][1][6] } else { ligneEPS112.children[j].innerHTML = 0 }
      //if (listStudent[i][2][5]) { ligneEPS112.children[j].innerHTML = listStudent[i][2][6] } else { ligneEPS112.children[j].innerHTML = 0 }
    } //Crédits
  ...
  for (j = 0; j <= ligneEPS113.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (listStudent[i][3][0] >= 7 && listStudent[i][3][0] < 10 && listStudent[i][3][3] >= 10) {
        ...
        ligneEPS113.children[j].innerHTML = "Non validée";
      } //if (listStudent[i][3][5]) { ligneEPS113.children[j].innerHTML = "Validée" } else { ligneEPS113.children[j].innerHTML = "Non validée" } 
    ...
    if (j == 10) {
      ligneEPS113.children[j].innerHTML = listStudent[i][3][7]; //if (listStudent[i][3][5]) { ligneEPS113.children[j].innerHTML = listStudent[i][3][6] } else { ligneEPS113.children[j].innerHTML = 0 } 
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS114.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][4][0] >= 7 && listStudent[i][4][0] < 10 && listStudent[i][3][3] >= 10) {
        ...
        ligneEPS114.children[j].innerHTML = "Non validée";
      } //if (listStudent[i][4][5]) { ligneEPS114.children[j].innerHTML = "Validée" } else { ligneEPS114.children[j].innerHTML = "Non validée" } 
    ...
    if (j == 8) {
      ligneEPS114.children[j].innerHTML = listStudent[i][4][7]; //if (listStudent[i][4][5]) { ligneEPS114.children[j].innerHTML = listStudent[i][4][6] } else { ligneEPS114.children[j].innerHTML = 0 } 
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS115a.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ligneEPS115a.children[j].innerHTML = listStudent[i][5][7]; //if ((listStudent[i][5][0] + listStudent[i][6][0] + listStudent[i][7][0] + listStudent[i][8][0] + listStudent[i][9][0] + listStudent[i][10][0]) >= 48) { ligneEPS115a.children[j].innerHTML = listStudent[i][5][6] } else { ligneEPS115a.children[j].innerHTML = 0 } 
  ...
  for (j = 0; j <= ligneEPS115b.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent[i][6][0] >= 7 && listStudent[i][6][0] < 10 && listStudent[i][3][3] >= 10) {
        ...
        ligneEPS115b.children[j].innerHTML = "Non validée";
      } //if (listStudent[i][6][5]) { ligneEPS115b.children[j].innerHTML = "Validée" } else { ligneEPS115b.children[j].innerHTML = "Non validée" } 
    ...
    if (j == 8) {
      ligneEPS115b.children[j].innerHTML = listStudent[i][6][7]; //if (listStudent[i][6][5]) { ligneEPS115b.children[j].innerHTML = listStudent[i][6][6] } else { ligneEPS115b.children[j].innerHTML = 0 } 
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS115f.childElementCount - 1; j++) {
    if (j == 2) {
      ligneEPS115f.children[j].innerHTML = listStudent[i][7][0];
    } //note info


    if (j == 3) {
      ligneEPS115f.children[j].innerHTML = listStudent[i][7][1];
    } //coef info


    if (j == 4) {
      /*val=ligneEPS115f.children[2].innerHTML*ligneEPS115f.children[3].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      ligneEPS115f.children[j].innerHTML = listStudent[i][7][2];
    } //total note math * coef


    if (j == 5) {
      ligneEPS115f.children[j].innerHTML = listStudent[i][7][4];
    } //


    if (j == 6) {
      if (listStudent[i][7][0] >= 7 && listStudent[i][7][0] < 10 && listStudent[i][3][3] >= 10) {
        ligneEPS115f.children[j].innerHTML = "Validée";
      } else if (listStudent[i][7][0] >= 10) {
        ligneEPS115f.children[j].innerHTML = "Validée";
      } else if (listStudent[i][7][0] < 10) {
        ligneEPS115f.children[j].innerHTML = "Non validée";
      } //if (listStudent[i][7][5]) { ligneEPS115f.children[j].innerHTML = "Validée" } else { ligneEPS115f.children[j].innerHTML = "Non validée" } 

    } //Mention


    if (j == 7) {
      ligneEPS115f.children[j].innerHTML = mydata[4];
    } //session


    if (j == 8) {
      ligneEPS115f.children[j].innerHTML = listStudent[i][7][7]; //if (listStudent[i][7][5]) { ligneEPS115f.children[j].innerHTML = listStudent[i][7][6] } else { ligneEPS115f.children[j].innerHTML = 0 } 
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS115g.childElementCount - 1; j++) {
    if (j == 2) {
      ligneEPS115g.children[j].innerHTML = listStudent[i][8][0];
    } //note info


    if (j == 3) {
      ligneEPS115g.children[j].innerHTML = listStudent[i][8][1];
    } //coef info


    if (j == 4) {
      /*val=ligneEPS115g.children[2].innerHTML*ligneEPS115g.children[3].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      ligneEPS115g.children[j].innerHTML = listStudent[i][8][2];
    } //total note math * coef


    if (j == 5) {
      ligneEPS115g.children[j].innerHTML = listStudent[i][8][4];
    } //


    if (j == 6) {
      if (listStudent[i][8][0] >= 7 && listStudent[i][8][0] < 10 && listStudent[i][3][3] >= 10) {
        ligneEPS115g.children[j].innerHTML = "Validée";
      } else if (listStudent[i][8][0] >= 10) {
        ligneEPS115g.children[j].innerHTML = "Validée";
      } else if (listStudent[i][8][0] < 10) {
        ligneEPS115g.children[j].innerHTML = "Non validée";
      } //if (listStudent[i][8][5]) { ligneEPS115g.children[j].innerHTML = "Validée" } else { ligneEPS115g.children[j].innerHTML = "Non validée" } 

    } //Mention


    if (j == 7) {
      ligneEPS115g.children[j].innerHTML = mydata[4];
    } //session


    if (j == 8) {
      ligneEPS115g.children[j].innerHTML = listStudent[i][8][7]; //if (listStudent[i][8][5]) { ligneEPS115g.children[j].innerHTML = listStudent[i][8][6] } else { ligneEPS115g.children[j].innerHTML = 0 } 
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS115j.childElementCount - 1; j++) {
    if (j == 2) {
      ligneEPS115j.children[j].innerHTML = listStudent[i][9][0];
    } //note info


    if (j == 3) {
      ligneEPS115j.children[j].innerHTML = listStudent[i][9][1];
    } //coef info


    if (j == 4) {
      /*val=ligneEPS115j.children[2].innerHTML*ligneEPS115j.children[3].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      ligneEPS115j.children[j].innerHTML = listStudent[i][9][2];
    } //total note math * coef


    if (j == 5) {
      ligneEPS115j.children[j].innerHTML = listStudent[i][9][4];
    } //


    if (j == 6) {
      if (listStudent[i][9][0] >= 7 && listStudent[i][9][0] < 10 && listStudent[i][3][3] >= 10) {
        ligneEPS115j.children[j].innerHTML = "Validée";
      } else if (listStudent[i][9][0] >= 10) {
        ligneEPS115j.children[j].innerHTML = "Validée";
      } else if (listStudent[i][9][0] < 10) {
    ...
    if (j == 8) {
      if (listStudent[i][9][5]) {
        ligneEPS115j.children[j].innerHTML = listStudent[i][9][6];
      } else {
        ligneEPS115j.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS115l.childElementCount - 1; j++) {
    if (j == 2) {
      ligneEPS115l.children[j].innerHTML = listStudent[i][10][0];
    } //note info


    if (j == 3) {
      ligneEPS115l.children[j].innerHTML = listStudent[i][10][1];
    } //coef info


    if (j == 4) {
      /*val=ligneEPS115l.children[2].innerHTML*ligneEPS115l.children[3].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      ligneEPS115l.children[j].innerHTML = listStudent[i][10][2];
    } //total note math * coef


    if (j == 5) {
      ligneEPS115l.children[j].innerHTML = listStudent[i][10][4];
    } //


    if (j == 6) {
      if (listStudent[i][10][0] >= 7 && listStudent[i][10][0] < 10 && listStudent[i][3][3] >= 10) {
        ligneEPS115l.children[j].innerHTML = "Validée";
      } else if (listStudent[i][10][0] >= 10) {
        ligneEPS115l.children[j].innerHTML = "Validée";
      } else if (listStudent[i][10][0] < 10) {
        ligneEPS115l.children[j].innerHTML = "Non validée";
      } //if (listStudent[i][10][5]) { ligneEPS115l.children[j].innerHTML = "Validée" } else { ligneEPS115l.children[j].innerHTML = "Non validée" }
    ...
    if (j == 8) {
      ligneEPS115l.children[j].innerHTML = listStudent[i][10][7]; //if (listStudent[i][10][5]) { ligneEPS115l.children[j].innerHTML = listStudent[i][10][6] } else { ligneEPS115l.children[j].innerHTML = 0 } 
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS116.childElementCount - 1; j++) {
    if (j == 2) {
      ligneEPS116.children[j].innerHTML = listStudent[i][11][0];
    } //note info


    if (j == 3) {
      ligneEPS116.children[j].innerHTML = listStudent[i][11][1];
    } //coef info


    if (j == 4) {
      /*val=ligneEPS116.children[2].innerHTML*ligneEPS116.children[3].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      ligneEPS116.children[j].innerHTML = listStudent[i][11][2];
    } //total note math * coef
    ...
    if (j == 6) {
      if (listStudent[i][11][0] >= 7 && listStudent[i][11][0] < 10 && listStudent[i][3][3] >= 10) {
        ligneEPS116.children[j].innerHTML = "Validée";
      } else if (listStudent[i][11][0] >= 10) {
        ligneEPS116.children[j].innerHTML = "Validée";
      } else if (listStudent[i][11][0] < 10) {
        ligneEPS116.children[j].innerHTML = "Non validée";
      } //if (listStudent[i][11][5]) { ligneEPS116.children[j].innerHTML = "Validée" } else { ligneEPS116.children[j].innerHTML = "Non validée" } 
    ...
    if (j == 8) {
      ligneEPS116.children[j].innerHTML = listStudent[i][11][7]; //if (listStudent[i][11][5]) { ligneEPS116.children[j].innerHTML = listStudent[i][11][6] } else { ligneEPS116.children[j].innerHTML = 0 } 
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS117.childElementCount - 1; j++) {
    if (j == 3) {
      ligneEPS117.children[j].innerHTML = listStudent[i][12][0];
    } //note info


    if (j == 4) {
      ligneEPS117.children[j].innerHTML = listStudent[i][12][1];
    } //coef info
    ...
    if (j == 6) {
      ligneEPS117.children[j].innerHTML = listStudent[i][12][3];
    } //


    if (j == 7) {
      ligneEPS117.children[j].innerHTML = listStudent[i][12][4];
    }

    if (j == 8) {
      if (listStudent[i][12][0] >= 7 && listStudent[i][12][0] < 10 && listStudent[i][12][3] >= 10) {
        ligneEPS117.children[j].innerHTML = "Validée";
      } else if (listStudent[i][12][0] >= 10) {
        ligneEPS117.children[j].innerHTML = "Validée";
      } else if (listStudent[i][12][0] < 10) {
        ligneEPS117.children[j].innerHTML = "Non validée";
      } //if (listStudent[i][12][5]) { ligneEPS117.children[j].innerHTML = "Validée" } else { ligneEPS117.children[j].innerHTML = "Non validée" }
    ...
    if (j == 10) {
      ligneEPS117.children[j].innerHTML = listStudent[i][12][7]; //if (listStudent[i][12][5]) { ligneEPS117.children[j].innerHTML = listStudent[i][12][6] } else { ligneEPS117.children[j].innerHTML = 0 }
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS118.childElementCount - 1; j++) {
    if (j == 2) {
      ligneEPS118.children[j].innerHTML = listStudent[i][13][0];
    } //note info


    if (j == 3) {
      ligneEPS118.children[j].innerHTML = listStudent[i][13][1];
    } //coef info


    if (j == 4) {
      /*val=ligneEPS118.children[2].innerHTML*ligneEPS118.children[3].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      ligneEPS118.children[j].innerHTML = listStudent[i][13][2];
    } //total note math * coef


    if (j == 5) {
      ligneEPS118.children[j].innerHTML = listStudent[i][13][4];
    } //


    if (j == 6) {
      if (listStudent[i][13][0] >= 7 && listStudent[i][13][0] < 10 && listStudent[i][12][3] >= 10) {
        ligneEPS118.children[j].innerHTML = "Validée";
      } else if (listStudent[i][13][0] >= 10) {
        ligneEPS118.children[j].innerHTML = "Validée";
      } else if (listStudent[i][13][0] < 10) {
        ligneEPS118.children[j].innerHTML = "Non validée";
      } //if (listStudent[i][13][5]) { ligneEPS118.children[j].innerHTML = "Validée" } else { ligneEPS118.children[j].innerHTML = "Non validée" } 
    ...
    if (j == 8) {
      ligneEPS118.children[j].innerHTML = listStudent[i][13][7]; //if (listStudent[i][13][5]) { ligneEPS118.children[j].innerHTML = listStudent[i][13][6] } else { ligneEPS118.children[j].innerHTML = 0 } 
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEPS119.childElementCount - 1; j++) {
    if (j == 2) {
      ligneEPS119.children[j].innerHTML = listStudent[i][14][0];
    } //note info


    if (j == 3) {
      ligneEPS119.children[j].innerHTML = listStudent[i][14][1];
    } //coef info


    if (j == 4) {
      ligneEPS119.children[j].innerHTML = listStudent[i][14][2];
    } //total note math * coef


    if (j == 5) {
      ligneEPS119.children[j].innerHTML = listStudent[i][14][4];
    } //


    if (j == 6) {
      if (listStudent[i][14][0] >= 7 && listStudent[i][14][0] < 10 && listStudent[i][12][3] >= 10) {
        ligneEPS119.children[j].innerHTML = "Validée";
      } else if (listStudent[i][14][0] >= 10) {
        ligneEPS119.children[j].innerHTML = "Validée";
      } else if (listStudent[i][14][0] < 10) {
        ligneEPS119.children[j].innerHTML = "Non validée";
      } //if (listStudent[i][14][5]) { ligneEPS119.children[j].innerHTML = "Validée" } else { ligneEPS119.children[j].innerHTML = "Non validée" } 
    ...
    if (j == 8) {
      ligneEPS119.children[j].innerHTML = listStudent[i][14][7]; //if (listStudent[i][14][5]) { ligneEPS119.children[j].innerHTML = listStudent[i][14][6] } else { ligneEPS119.children[j].innerHTML = 0 } 
    } //nombre_crédits
  ...
  for (j = 0; j <= resultat.childElementCount - 1; j++) {
    ...
    if (j == 2) {
      resultat.children[2].innerHTML = listStudent[i][15][1];
    }

    if (j == 3) {
      resultat.children[j].innerHTML = listStudent[i][15][2];
    }

    if (j == 4) {
      resultat.children[j].innerHTML = mydata[2].indexOf(listStudent[i][15][2]) + 1;
    }
  ...
  for (j = 0; j <= ligne0.childElementCount - 1; j++) {
    if (j == 2) {
      ligne0.children[2].innerHTML = "".concat(listStudent[i][15][2], " / 20");
    }
  ...
  var s4body = clone.children[2].children[3].children[0].children[1]; //Ligne 3
  ...
  for (var j = 0; j <= ligne33.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      if (listStudent2[i][1][0] >= 7 && listStudent2[i][1][0] < 10 && listStudent2[i][1][3] >= 10) {
        ligne33.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][1][0] >= 10) {
        ligne33.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][1][0] < 10) {
        ligne33.children[j].innerHTML = "Non validée";
      }
  ...
  for (j = 0; j <= ligne44.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent2[i][2][0] >= 7 && listStudent2[i][2][0] < 10 && listStudent2[i][1][3] >= 10) {
        ligne44.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][2][0] >= 10) {
        ligne44.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][2][0] < 10) {
        ligne44.children[j].innerHTML = "Non validée";
      }
  ...
  for (j = 0; j <= ligne55.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent2[i][3][0] >= 7 && listStudent2[i][3][0] < 10 && listStudent2[i][1][3] >= 10) {
        ligne55.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][3][0] >= 10) {
        ligne55.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][3][0] < 10) {
        ligne55.children[j].innerHTML = "Non validée";
      }
    ...
    } //if (j == 8) { ligne55.children[j].innerHTML = listStudent2[i][2][9] }
  ...
  for (j = 0; j <= ligne66.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent2[i][4][0] >= 7 && listStudent2[i][4][0] < 10 && listStudent2[i][1][3] >= 10) {
        ligne66.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][4][0] >= 10) {
        ligne66.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][4][0] < 10) {
        ligne66.children[j].innerHTML = "Non validée";
      }
  ...
  for (j = 0; j <= ligne77.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent2[i][5][0] >= 7 && listStudent2[i][5][0] < 10 && listStudent2[i][1][3] >= 10) {
        ligne77.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][5][0] >= 10) {
        ligne77.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][5][0] < 10) {
        ligne77.children[j].innerHTML = "Non validée";
      }
  ...
  for (j = 0; j <= ligne88.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent2[i][6][0] >= 7 && listStudent2[i][6][0] < 10 && listStudent2[i][1][3] >= 10) {
        ligne88.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][6][0] >= 10) {
        ligne88.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][6][0] < 10) {
        ligne88.children[j].innerHTML = "Non validée";
      }
  ...
  for (j = 0; j <= lignee99.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent2[i][7][0] >= 7 && listStudent2[i][7][0] < 10 && listStudent2[i][1][3] >= 10) {
        lignee99.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][7][0] >= 10) {
        lignee99.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][7][0] < 10) {
  ...
  for (j = 0; j <= ligne10.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent2[i][8][0] >= 7 && listStudent2[i][8][0] < 10 && listStudent2[i][1][3] >= 10) {
        ligne10.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][8][0] >= 10) {
        ligne10.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][8][0] < 10) {
  ...
  for (j = 0; j <= ligne11.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      if (listStudent2[i][9][0] >= 7 && listStudent2[i][9][0] < 10 && listStudent2[i][1][3] >= 10) {
        ligne11.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][9][0] >= 10) {
        ligne11.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][9][0] < 10) {
        ligne11.children[j].innerHTML = "Non validée";
      }
  ...
  for (j = 0; j <= ligne12.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      ...
      if (listStudent2[i][10][0] >= 7 && listStudent2[i][10][0] < 10 && listStudent2[i][1][3] >= 10) {
        ligne12.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][10][0] >= 10) {
        ligne12.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][10][0] < 10) {
        ligne12.children[j].innerHTML = "Non validée";
      }
  ...
  for (j = 0; j <= ligne13.childElementCount - 1; j++) {
    ...
    if (j == 8) {
      ...
      if (listStudent2[i][11][0] >= 7 && listStudent2[i][11][0] < 10 && listStudent2[i][12][3] >= 10) {
        ligne13.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][11][0] >= 10) {
        ligne13.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][11][0] < 10) {
        ligne13.children[j].innerHTML = "Non validée";
      }
  ...
  for (j = 0; j <= ligne14.childElementCount - 1; j++) {
    ...
    if (j == 6) {
      ...
      if (listStudent2[i][12][0] >= 7 && listStudent2[i][12][0] < 10 && listStudent2[i][12][3] >= 10) {
        ligne14.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][12][0] >= 10) {
        ligne14.children[j].innerHTML = "Validée";
      } else if (listStudent2[i][12][0] < 10) {
        ligne14.children[j].innerHTML = "Non validée";
      }
...
function BullEVE(clone, i) {
  ...
  var tbody = clone.children[2].children[2].children[0].children[1]; //LIGNE MAS 315

  var ligneMAS315 = tbody.children[0];

  for (j = 0; j <= ligneMAS315.childElementCount - 1; j++) {
    if (j == 4) {
      ligneMAS315.children[j].innerHTML = listStudent[i][1][0];
    } //note math


    if (j == 5) {
      ligneMAS315.children[j].innerHTML = listStudent[i][1][1];
    } //coef math


    if (j == 6) {
      ligneMAS315.children[j].innerHTML = listStudent[i][1][2];
    } //total note math * coef


    if (j == 7) {
      ligneMAS315.children[j].innerHTML = listStudent[i][1][3];
    } //moyenne donc (totalmath + totalinfo)/2


    if (j == 8) {
      ligneMAS315.children[j].innerHTML = listStudent[i][1][4];
      /*ligneMAS315.children[j].innerHTML =  mds1sort.indexof(mds111[i]['note_Examen'])*/
    } //Rang


    if (j == 9) {
      if (listStudent[i][1][0] >= 7 && listStudent[i][1][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMAS315.children[j].innerHTML = "Validée";
      } else if (listStudent[i][1][0] >= 10) {
        ligneMAS315.children[j].innerHTML = "Validée";
      } else if (listStudent[i][1][0] < 10) {
        ligneMAS315.children[j].innerHTML = "Non validée";
      }
    } //Mention


    if (j == 10) {
      if (listStudent[i][1][8] == "Rattrapage") {
        ligneMAS315.children[j].innerHTML = listStudent[i][1][8];
      } else {
        ligneMAS315.children[j].innerHTML = "Janvier 2023";
      }
    } //Session
    ...
    if (j == 11) {
      if (listStudent[i][1][0] >= 7 && listStudent[i][1][3] >= 10 || listStudent[i][1][0] >= 10) {
        ligneMAS315.children[j].innerHTML = listStudent[i][1][6];
      } else {
        ligneMAS315.children[j].innerHTML = 0;
      }
    } //Crédits
  ...
  for (j = 0; j <= ligneMAS325.childElementCount - 1; j++) {
    if (j == 2) {
      ligneMAS325.children[j].innerHTML = listStudent[i][2][0];
    } //note info


    if (j == 3) {
      ligneMAS325.children[j].innerHTML = listStudent[i][2][1];
    } //coef info


    if (j == 4) {
      /*val=ligneMAS325.children[2].innerHTML*ligneMAS325.children[3].innerHTML; val= val.toFixed(2); val = parseFloat(val);*/
      ligneMAS325.children[j].innerHTML = listStudent[i][2][2];
    } //total note math * coef


    if (j == 5) {
      ligneMAS325.children[j].innerHTML = listStudent[i][2][4];
    } //Rang


    if (j == 6) {
      if (listStudent[i][2][0] >= 7 && listStudent[i][2][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMAS325.children[j].innerHTML = "Validée";
      } else if (listStudent[i][2][0] >= 10) {
        ligneMAS325.children[j].innerHTML = "Validée";
      } else if (listStudent[i][2][0] < 10) {
        ligneMAS325.children[j].innerHTML = "Non validée";
      }
    }

    if (j == 7) {
      if (listStudent[i][2][8] == "Rattrapage") {
        ligneMAS325.children[j].innerHTML = listStudent[i][2][8];
      } else {
        ligneMAS325.children[j].innerHTML = "Janvier 2023";
      }
    } //Session
    ...
    if (j == 8) {
      if (listStudent[i][2][0] >= 7 && listStudent[i][1][3] >= 10 || listStudent[i][2][0] >= 10) {
        ligneMAS325.children[j].innerHTML = listStudent[i][2][6];
      } else {
        ligneMAS325.children[j].innerHTML = 0;
      }
    } //Crédits
  ...
  for (j = 0; j <= ligneMAS335.childElementCount - 1; j++) {
    if (j == 2) {
      ligneMAS335.children[j].innerHTML = listStudent[i][3][0];
    } //note info


    if (j == 3) {
      ligneMAS335.children[j].innerHTML = listStudent[i][3][1];
    } //coef info


    if (j == 4) {
      ligneMAS335.children[j].innerHTML = listStudent[i][3][2];
    } //total note math * coef


    if (j == 5) {
      ligneMAS335.children[j].innerHTML = listStudent[i][3][4];
    } //Rang
    ...
    if (j == 6) {
      ...
      if (listStudent[i][3][0] >= 7 && listStudent[i][3][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMAS335.children[j].innerHTML = "Validée";
      } else if (listStudent[i][3][0] >= 10) {
        ligneMAS335.children[j].innerHTML = "Validée";
      } else if (listStudent[i][3][0] < 10) {
        ligneMAS335.children[j].innerHTML = "Non validée";
      }
    } //Mention


    if (j == 7) {
      if (listStudent[i][3][8] == "Rattrapage") {
        ligneMAS335.children[j].innerHTML = listStudent[i][3][8];
      } else {
        ligneMAS335.children[j].innerHTML = "Janvier 2023";
      }
    }

    if (j == 8) {
      if (listStudent[i][3][0] >= 7 && listStudent[i][1][3] >= 10 || listStudent[i][3][0] >= 10) {
        ligneMAS335.children[j].innerHTML = listStudent[i][3][6];
      } else {
        ligneMAS335.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneMAS345.childElementCount - 1; j++) {
    if (j == 2) {
      ligneMAS345.children[j].innerHTML = listStudent[i][4][0];
    } //note info


    if (j == 3) {
      ligneMAS345.children[j].innerHTML = listStudent[i][4][1];
    } //coef info


    if (j == 4) {
      ligneMAS345.children[j].innerHTML = listStudent[i][4][2];
    } //total note math * coef


    if (j == 5) {
      ligneMAS345.children[j].innerHTML = listStudent[i][4][4];
    } //Rang
    ...
    if (j == 6) {
      ...
      if (listStudent[i][4][0] >= 7 && listStudent[i][4][0] < 10 && listStudent[i][1][3] >= 10) {
        ligneMAS345.children[j].innerHTML = "Validée";
      } else if (listStudent[i][4][0] >= 10) {
        ligneMAS345.children[j].innerHTML = "Validée";
      } else if (listStudent[i][4][0] < 10) {
        ligneMAS345.children[j].innerHTML = "Non validée";
      }
    } //Mention


    if (j == 7) {
      if (listStudent[i][4][8] == "Rattrapage") {
        ligneMAS345.children[j].innerHTML = listStudent[i][4][8];
      } else {
        ligneMAS345.children[j].innerHTML = "Janvier 2023";
      }
    }

    if (j == 8) {
      if (listStudent[i][4][0] >= 7 && listStudent[i][1][3] >= 10 || listStudent[i][4][0] >= 10) {
        ligneMAS345.children[j].innerHTML = listStudent[i][4][6];
      } else {
        ligneMAS345.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneMAS355.childElementCount - 1; j++) {
    if (j == 3) {
      ligneMAS355.children[j].innerHTML = listStudent[i][5][0];
    } //note math


    if (j == 4) {
      ligneMAS355.children[j].innerHTML = listStudent[i][5][1];
    } //coef math


    if (j == 5) {
      ligneMAS355.children[j].innerHTML = listStudent[i][5][2];
    } //total note math * coef


    if (j == 6) {
      ligneMAS355.children[j].innerHTML = listStudent[i][5][3];
    }

    if (j == 7) {
      ligneMAS355.children[j].innerHTML = listStudent[i][5][4];
    } //Rang


    if (j == 8) {
      if (listStudent[i][5][0] >= 7 && listStudent[i][5][0] < 10 && listStudent[i][5][3] >= 10) {
        ligneMAS355.children[j].innerHTML = "Validée";
      } else if (listStudent[i][5][0] >= 10) {
        ligneMAS355.children[j].innerHTML = "Validée";
      } else if (listStudent[i][5][0] < 10) {
        ligneMAS355.children[j].innerHTML = "Non validée";
      }
    } //Mention


    if (j == 9) {
      if (listStudent[i][5][8] == "Rattrapage") {
        ligneMAS355.children[j].innerHTML = listStudent[i][5][8];
      } else {
        ligneMAS355.children[j].innerHTML = "Janvier 2023";
      }
    }

    if (j == 10) {
      if (listStudent[i][5][0] >= 7 && listStudent[i][5][3] >= 10 || listStudent[i][5][0] >= 10) {
        ligneMAS355.children[j].innerHTML = listStudent[i][5][6];
      } else {
        ligneMAS355.children[j].innerHTML = 0;
      }
    } //Crédits
  ...
  for (j = 0; j <= ligneMAS365.childElementCount - 1; j++) {
    if (j == 2) {
      ligneMAS365.children[j].innerHTML = listStudent[i][6][0];
    } //note info


    if (j == 3) {
      ligneMAS365.children[j].innerHTML = listStudent[i][6][1];
    } //coef info


    if (j == 4) {
      ligneMAS365.children[j].innerHTML = listStudent[i][6][2];
    } //total note math * coef


    if (j == 5) {
      ligneMAS365.children[j].innerHTML = listStudent[i][6][4];
    } //Rang


    if (j == 6) {
      if (listStudent[i][6][0] >= 7 && listStudent[i][6][0] < 10 && listStudent[i][5][3] >= 10) {
        ligneMAS365.children[j].innerHTML = "Validée";
      } else if (listStudent[i][6][0] >= 10) {
        ligneMAS365.children[j].innerHTML = "Validée";
      } else if (listStudent[i][6][0] < 10) {
        ligneMAS365.children[j].innerHTML = "Non validée";
      }
    } //Mention


    if (j == 7) {
      if (listStudent[i][6][8] == "Rattrapage") {
        ligneMAS365.children[j].innerHTML = listStudent[i][6][8];
      } else {
        ligneMAS365.children[j].innerHTML = "Janvier 2023";
      }
    } //Session
    ...
    if (j == 8) {
      if (listStudent[i][6][0] >= 7 && listStudent[i][5][3] >= 10 || listStudent[i][6][0] >= 10) {
        ligneMAS365.children[j].innerHTML = listStudent[i][6][6];
      } else {
        ligneMAS365.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= resultat.childElementCount - 1; j++) {
    ...
    if (j == 2) {
      resultat.children[2].innerHTML = listStudent[i][7][1];
    }

    if (j == 3) {
      resultat.children[j].innerHTML = listStudent[i][7][2];
    }
    ...
    if (j == 6) {
      resultat.children[j].innerHTML = sommeInt6(ligneMAS315.children[11].innerHTML, ligneMAS325.children[8].innerHTML, ligneMAS335.children[8].innerHTML, ligneMAS345.children[8].innerHTML, ligneMAS355.children[10].innerHTML, ligneMAS365.children[8].innerHTML);
    }
    /**TOtal Crédit */
  ...
  for (j = 0; j <= ligne1.childElementCount - 1; j++) {
    if (j == 5) {
      ligne2.children[j].innerHTML = "".concat(mydata[2].indexOf(listStudent[i][7][2]) + 1, " sur ").concat(mydata[1].length);
    }
  ...
  semestre6 = mydata[9];
  s6body = clone.children[2].children[3].children[0].children[1]; //LIGNE MAS 316
  ...
  for (j = 0; j <= ligneMAS316.childElementCount - 1; j++) {
    if (j == 0) {
      ligneMAS316.children[j].innerHTML = "SEMESTRE 6";
    }

    if (j == 2) {
      ligneMAS316.children[j].innerHTML = "MAS316";
    }

    if (j == 3) {
      ligneMAS316.children[j].innerHTML = "Management des infrastructures et équipements sportifs";
    }

    if (j == 4) {
      ligneMAS316.children[j].innerHTML = semestre6[i][1][0];
    } //note math


    if (j == 5) {
      ligneMAS316.children[j].innerHTML = semestre6[i][1][1];
    } //coef math


    if (j == 6) {
      ligneMAS316.children[j].innerHTML = semestre6[i][1][2];
    } //total note math * coef


    if (j == 7) {
      ligneMAS316.children[j].innerHTML = semestre6[i][1][3];
    } //moyenne donc (totalmath + totalinfo)/2


    if (j == 8) {
      ligneMAS316.children[j].innerHTML = semestre6[i][1][4];
      /*ligneMAS316.children[j].innerHTML =  mds1sort.indexof(mds111[i]['note_Examen'])*/
    } //Rang


    if (j == 9) {
      if (semestre6[i][1][0] >= 7 && semestre6[i][1][0] < 10 && semestre6[i][1][3] >= 10) {
        ligneMAS316.children[j].innerHTML = "Validée";
      } else if (semestre6[i][1][0] >= 10) {
        ligneMAS316.children[j].innerHTML = "Validée";
      } else if (semestre6[i][1][0] < 7) {
        ligneMAS316.children[j].innerHTML = "Non validée";
      }
      /*if (semestre6[i][1][5]) {
    ...
    if (j == 10) {
      ligneMAS316.children[j].innerHTML = 'Mai 2023';
    } //Session


    if (j == 11) {
      if (semestre6[i][1][0] >= 7 && semestre6[i][1][3] >= 10 || semestre6[i][1][0] >= 10) {
        ligneMAS316.children[j].innerHTML = semestre6[i][1][6];
      } else {
        ligneMAS316.children[j].innerHTML = 0;
      }
    } //Crédits
  ...
  for (j = 0; j <= ligneMAS326.childElementCount - 1; j++) {
    if (j == 0) {
      ligneMAS326.children[j].innerHTML = "MAS326";
    }

    if (j == 1) {
      ligneMAS326.children[j].innerHTML = "Management des ressources financières";
    }

    if (j == 2) {
      ligneMAS326.children[j].innerHTML = semestre6[i][2][0];
    } //note info


    if (j == 3) {
      ligneMAS326.children[j].innerHTML = semestre6[i][2][1];
    } //coef info


    if (j == 4) {
      /*val=ligneMAS326.children[2].innerHTML*ligneMAS326.children[3].innerHTML; val= val.toFixed(2); val = parseFloat(val);*/
      ligneMAS326.children[j].innerHTML = semestre6[i][2][2];
    } //total note math * coef


    if (j == 5) {
      ligneMAS326.children[j].innerHTML = semestre6[i][2][4];
    } //Rang


    if (j == 6) {
      if (semestre6[i][2][0] >= 7 && semestre6[i][2][0] < 10 && semestre6[i][1][3] >= 10) {
        ligneMAS326.children[j].innerHTML = "Validée";
      } else if (semestre6[i][2][0] >= 10) {
        ligneMAS326.children[j].innerHTML = "Validée";
      } else
        /*if ( /*semestre6[i][2][0] < 7 || semestre6[i][2][0] < 10)*/
        {
          ligneMAS326.children[j].innerHTML = "Non validée";
        } //if (semestre6[i][2][5]) { ligneMAS326.children[6].innerHTML = "Validée" } else { ligneMAS326.children[6].innerHTML = "Non validée" }

    }

    if (j == 7) {
      ligneMAS326.children[j].innerHTML = 'Mai 2023';
    } //Session


    if (j == 8) {
      if (semestre6[i][2][0] >= 7 && semestre6[i][1][3] >= 10 || semestre6[i][2][0] >= 10) {
        ligneMAS326.children[j].innerHTML = semestre6[i][2][6];
      } else {
        ligneMAS326.children[j].innerHTML = 0;
      }
    } //Crédits
  ...
  for (j = 0; j <= ligneMAS336.childElementCount - 1; j++) {
    if (j == 0) {
      ligneMAS336.children[j].innerHTML = "MAS336";
    }

    if (j == 1) {
      ligneMAS336.children[j].innerHTML = "Gestion des Ressources Humaines";
    }

    if (j == 2) {
      ligneMAS336.children[j].innerHTML = semestre6[i][3][0];
    } //note info


    if (j == 3) {
      ligneMAS336.children[j].innerHTML = semestre6[i][3][1];
    } //coef info


    if (j == 4) {
      /*val=ligneMAS336.children[2].innerHTML*ligneMAS336.children[3].innerHTML; val=val.toFixed(2); val=parseFloat(val);*/
      ligneMAS336.children[j].innerHTML = semestre6[i][3][2];
    } //total note math * coef


    if (j == 5) {
      ligneMAS336.children[j].innerHTML = semestre6[i][3][4];
    } //Rang


    if (j == 6) {
      if (semestre6[i][3][0] >= 7 && semestre6[i][3][0] < 10 && semestre6[i][1][3] >= 10) {
        ligneMAS336.children[j].innerHTML = "Validée";
      } else if (semestre6[i][3][0] >= 10) {
        ligneMAS336.children[j].innerHTML = "Validée";
      } else if (semestre6[i][3][0] < 7) {
        ligneMAS336.children[j].innerHTML = "Non validée";
      }
    } //Mention


    if (j == 7) {
      ligneMAS336.children[j].innerHTML = 'Mai 2023';
    } //Session


    if (j == 8) {
      if (semestre6[i][3][0] >= 7 && semestre6[i][1][3] >= 10 || semestre6[i][3][0] >= 10) {
        ligneMAS336.children[j].innerHTML = semestre6[i][3][6];
      } else {
        ligneMAS336.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneMAS346.childElementCount - 1; j++) {
    if (j == 0) {
      ligneMAS346.children[j].innerHTML = "MAS346";
    }

    if (j == 1) {
      ligneMAS346.children[j].innerHTML = "Stage Professionnel";
    }

    if (j == 2) {
      ligneMAS346.children[j].innerHTML = semestre6[i][4][0];
    } //note info


    if (j == 3) {
      ligneMAS346.children[j].innerHTML = semestre6[i][4][1];
    } //coef info


    if (j == 4) {
      ligneMAS346.children[j].innerHTML = semestre6[i][4][2];
    } //total note math * coef


    if (j == 5) {
      ligneMAS346.children[j].innerHTML = semestre6[i][4][4];
    } //Rang


    if (j == 6) {
      if (semestre6[i][4][0] >= 7 && semestre6[i][4][0] < 10 && semestre6[i][1][3] >= 10) {
        ligneMAS346.children[j].innerHTML = "Validée";
      } else if (semestre6[i][4][0] >= 10) {
        ligneMAS346.children[j].innerHTML = "Validée";
      } else if (semestre6[i][4][0] < 7) {
        ligneMAS346.children[j].innerHTML = "Non validée";
      }
    } //Mention


    if (j == 7) {
      ligneMAS346.children[j].innerHTML = 'Mai 2023';
    } //Session


    if (j == 8) {
      if (semestre6[i][4][0] >= 7 && semestre6[i][1][3] >= 10 || semestre6[i][4][0] >= 10) {
        ligneMAS346.children[j].innerHTML = semestre6[i][4][6];
      } else {
        ligneMAS346.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= ligneEVE356.childElementCount - 1; j++) {
    if (j == 1) {
      ligneEVE356.children[j].innerHTML = "EVE356";
    }

    if (j == 2) {
      ligneEVE356.children[j].innerHTML = "Outils de soutien à l'Organisation des Evènements Sportifs";
    }

    if (j == 3) {
      ligneEVE356.children[j].innerHTML = semestre6[i][5][0];
    } //note math


    if (j == 4) {
      ligneEVE356.children[j].innerHTML = semestre6[i][5][1];
    } //coef math


    if (j == 5) {
      ligneEVE356.children[j].innerHTML = semestre6[i][5][2];
    } //total note math * coef


    if (j == 6) {
      ligneEVE356.children[j].innerHTML = semestre6[i][5][3];
    }

    if (j == 7) {
      ligneEVE356.children[j].innerHTML = semestre6[i][5][4];
    } //Rang


    if (j == 8) {
      //ligneEVE356.children[j].innerHTML = "zeze"
      if (semestre6[i][5][0] >= 7 && semestre6[i][5][0] < 10 && semestre6[i][5][3] >= 10) {
        ligneEVE356.children[j].innerHTML = "Validée";
      } else if (semestre6[i][5][0] >= 10) {
        ligneEVE356.children[j].innerHTML = "Validée";
      } else if (semestre6[i][5][0] < 10) {
        ligneEVE356.children[j].innerHTML = "Non validée";
      }
    } //Mention


    if (j == 9) {
      ligneEVE356.children[j].innerHTML = 'Mai 2023';
    } //Session


    if (j == 10) {
      if (semestre6[i][5][0] >= 7 && semestre6[i][5][3] >= 10 || semestre6[i][5][0] >= 10) {
        ligneEVE356.children[j].innerHTML = semestre6[i][5][6];
      } else {
        ligneEVE356.children[j].innerHTML = 0;
      }
    } //Crédits
  ...
  for (j = 0; j <= ligneEVE366.childElementCount - 1; j++) {
    if (j == 0) {
      ligneEVE366.children[j].innerHTML = "EVE366";
    }

    if (j == 1) {
      ligneEVE366.children[j].innerHTML = "Méthodologie de Rédaction des Rapports de Stage";
    }

    if (j == 2) {
      ligneEVE366.children[j].innerHTML = semestre6[i][6][0];
    } //note info


    if (j == 3) {
      ligneEVE366.children[j].innerHTML = semestre6[i][6][1];
    } //coef info


    if (j == 4) {
      ligneEVE366.children[j].innerHTML = semestre6[i][6][2];
    } //total note math * coef


    if (j == 5) {
      ligneEVE366.children[j].innerHTML = semestre6[i][6][4];
    } //Rang


    if (j == 6) {
      if (semestre6[i][6][0] >= 7 && semestre6[i][6][0] < 10 && semestre6[i][5][3] >= 10) {
        ligneEVE366.children[j].innerHTML = "Validée";
      } else if (semestre6[i][6][0] >= 10) {
        ligneEVE366.children[j].innerHTML = "Validée";
      } else
        /*if (semestre6[i][6][0] < 7)*/
        {
          ligneEVE366.children[j].innerHTML = "Non validée";
        }
    } //Mention


    if (j == 7) {
      ligneEVE366.children[j].innerHTML = 'Mai 2023';
    } //Session


    if (j == 8) {
      if (semestre6[i][6][0] >= 7 && semestre6[i][5][3] >= 10 || semestre6[i][6][0] >= 10) {
        ligneEVE366.children[j].innerHTML = semestre6[i][6][6];
      } else {
        ligneEVE366.children[j].innerHTML = 0;
      }
    } //nombre_crédits
  ...
  for (j = 0; j <= resultats6.childElementCount - 1; j++) {
    if (j == 0) {
      resultats6.children[j].innerHTML = 'RESULTATS SEMESTRE 6';
    }

    if (j == 1) {
      resultats6.children[1].innerHTML = semestre6[i][7][0];
      /*sommeInt1(ligneMDS111.children[5].innerHTML,ligneMDS111b.children[3].innerHTML,ligneMDS112.children[3].innerHTML,ligneMDS112b.children[3].innerHTML,ligneMDS113.children[4].innerHTML,ligneMDS114.children[3].innerHTML,ligneMDS115.children[3].innerHTML,ligneMDS116.children[3].innerHTML,ligneMDS117.children[4].innerHTML,ligneMDS117b.children[3].innerHTML);*/
    }

    if (j == 2) {
      resultats6.children[2].innerHTML = semestre6[i][7][1];
    }
    /*sommeFloat(ligneMDS111b.children[4].innerHTML, ligneMDS111.children[6].innerHTML, ligneMDS112.children[4].innerHTML, ligneMDS113.children[5].innerHTML, ligneMDS114.children[4].innerHTML, ligneMDS115.children[4].innerHTML,ligneMDS116.children[4].innerHTML, ligneMDS117.children[5].innerHTML, ligneMDS112b.children[4].innerHTML, ligneMDS117b.children[4].innerHTML) }*/


    if (j == 3) {
      resultats6.children[j].innerHTML = semestre6[i][7][2];
    }

    if (j == 4) {
      resultats6.children[j].innerHTML = mydata[10].indexOf(semestre6[i][7][2]) + 1;
    }

    if (j == 5) {
      resultats6.children[j].innerHTML = 'Total Crédits Semestre 6';
    }

    if (j == 6) {
      resultats6.children[j].innerHTML = sommeInt6(ligneMAS316.children[11].innerHTML, ligneMAS326.children[8].innerHTML, ligneMAS336.children[8].innerHTML, ligneMAS346.children[8].innerHTML, ligneEVE356.children[10].innerHTML, ligneEVE366.children[8].innerHTML);
    }
    /**TOtal Crédit */
