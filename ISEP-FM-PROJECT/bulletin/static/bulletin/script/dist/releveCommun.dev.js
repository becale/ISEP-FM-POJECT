...
window.addEventListener('load', function () {
  ...
  /*for(i=0; i<=mydata[1].length-1; i++){
          ...
          tab116 = tab115['0'] //good line
            ...
            for(j=0; j<=tab15.childElementCount-1; j++){
              ...
              if(j==3){
                  ...
                  //TEST UE GROUPEES 
                  if((listStudent[i][5][0]+listStudent[i][6][0]+listStudent[i][7][0]+listStudent[i][8][0])/4 >= 10){creditEPS115 = 6}else{creditEPS115 = 0}
          ...
          for(j=0; j<=tab23.childElementCount-1; j++){
              ...
              if(j==7){tab23.cells[j].innerHTML =listStudent[i][3][3]};
              if(j==8){if( listStudent[i][3][3] >= 10){tab23.cells[j].innerHTML ='V'}else{tab23.cells[j].innerHTML ='NV'}};
          ...
          tab33 = tab32.children['0']
            for(j=0; j<=tab33.childElementCount-1; j++){
              ...
              if(j==3){tab33.cells[j].innerHTML =listStudent[i][10][3]};
              if(j==4){if ( listStudent[i][10][3] >= 10 ) { tab33.cells[j].innerHTML ='V' }else{ tab33.cells[j].innerHTML ='NV'};};
          }
  ...
  function Page1_2() {
    ...
    page0.children[0].children[2].children[0].innerHTML = "PROCES VERBAL MODULAIRE 1<sup>er</sup> SEMESTRE EPS1  ".concat(mydata[11][0]['annee_academique']);
    bigtab = page0.children[0].children[2].children[1];
    page = document.getElementById("part2");
    page = page.cloneNode(true); //page.children[0].children[2].children[0].innerHTML = `PROCES VERBAL MODULAIRE 1<sup>er</sup> SEMESTRE EPS1  ${mydata[11][0]['annee_academique']}`

    bigtab1 = page.children[0].children[1].children[1]; //Tableau Sur lequel on ajoute les nouvelles lignes

    worktab = bigtab.children[1];
    worktab.children[0].children[0].innerHTML = "PROCES VERBAL MODULAIRE EPS1 ".concat(mydata[11][0]['annee_academique']);
    worktab1 = bigtab1.children[1];
    worktab1.children[0].children[0].innerHTML = "PROCES VERBAL MODULAIRE EPS1 ".concat(mydata[11][0]['annee_academique']); //Ligne des 4 tableaux
    ...
    for (i = 0; i <= mydata[1].length - 1; i++) {
      ...
      for (j = 0; j <= tab15.childElementCount - 1; j++) {
        ...
        if (j == 2) {
          ...
          if (moyuef >= 10 && listStudent[i][1][0] >= 7 && listStudent[i][2][0] >= 7) {
            ...
            moyuefcr =
            /*uef1cr + uef2cr*/
            listStudent[i][1][6] + listStudent[i][2][6];
          } else {
            moyuef = '--';
      ...
      for (j = 0; j <= tab23.childElementCount - 1; j++) {
        ...
        if (j == 9) {
          ...
          var uef9cr = listStudent[i][11][7]; //if (listStudent[i][9][0] < 10) { uef9cr = 0 }
          ...
          /*eps125Somme >= 7 &&*/
          listStudent[i][9][0] >= 7 && listStudent[i][10][0] >= 7 && listStudent[i][11][0] >= 7) {
            //console.log('OK');
            moyuepcr =
            /*uef3cr + uef4cr + uef5cr + uef9cr*/
            listStudent[i][3][6] + listStudent[i][4][6] + listStudent[i][5][7] + listStudent[i][11][6];
          } else {
            moyuep = '--';
      ...
      for (j = 0; j <= tab33.childElementCount - 1; j++) {
        ...
        if (j == 3) {
          var uef10cr = listStudent[i][12][7]; //if (listStudent[i][10][0] < 10) { uef10cr = 0 }

          var uef11cr = listStudent[i][13][7]; //if (listStudent[i][11][0] < 10) { uef11cr = 0 }

          var uef12cr = listStudent[i][14][7]; //if (listStudent[i][12][0] < 10) { uef12cr = 0 }
          ...
          if (moyuet >= 10 && listStudent[i][12][0] >= 7 && listStudent[i][13][0] >= 7 && listStudent[i][14][0] >= 7) {
            //console.log('OK');
            moyuetcr =
            /*uef10cr + uef11cr + uef12cr*/
            listStudent[i][12][6] + listStudent[i][13][6] + listStudent[i][14][6];
          } else {
            moyuet = '--';
      ...
      for (j = 0; j <= tab116.childElementCount - 1; j++) {
        ...
        if (j == 3) {
          tab116.cells[j].innerHTML = listStudent[i][15][3];
        } //rang }
  ...
  function PageRattrapage() {
    ...
    page2.children[0].children[2].children[0].innerHTML = "PROCES VERBAL MODULAIRE RATTRAPAGE 1<sup>er</sup> SEMESTRE EPS1  ".concat(mydata[11][0]['annee_academique']);
    ...
    page3.children[0].children[1].children[0].innerHTML = "PROCES VERBAL MODULAIRE RATTRAPAGE 1<sup>er</sup> SEMESTRE EPS1  ".concat(mydata[11][0]['annee_academique']);
    ...
    worktab2.children[0].children[0].innerHTML = "PROCES VERBAL MODULAIRE RATTRAPAGE ".concat(mydata[11][0]['annee_academique']);
    worktab3 = bigtab3.children[1];
    worktab3.children[0].children[0].innerHTML = "PROCES VERBAL MODULAIRE RATTRAPAGE ".concat(mydata[11][0]['annee_academique']);
    ...
    for (i = 0; i <= mydata[1].length - 1; i++) {
      ...
      for (j = 0; j <= tab23.childElementCount - 1; j++) {
        if (j == 0) {
          tab23.cells[j].innerHTML = listStudent[i][3] > 0 ? listStudent[i][3] : '--';
          /*listStudent[i][3][0]*/
        }
        ...
        if (j == 1) {
          tab23.cells[j].innerHTML = listStudent[i][4] > 0 ? listStudent[i][4] : '--';
        } //'--' /*listStudent[i][4][0]*/ }; //{if(listStudent[i][3][5]){tab23.cells[j].innerHTML ='V'}else{tab23.cells[j].innerHTML ='NV'}};


        if (j == 2) {
          tab23.cells[j].innerHTML = listStudent[i][5] > 0 ? listStudent[i][5] : '--';
        } //'--' /*listStudent[i][5][0]*/ };


        if (j == 3) {
          tab23.cells[j].innerHTML = listStudent[i][6] > 0 ? listStudent[i][6] : '--';
        } //'--' /*listStudent[i][6][0]*/ }; //{{if(listStudent[i][4][5]){tab23.cells[j].innerHTML ='V'}else{tab23.cells[j].innerHTML ='NV'}};};


        if (j == 4) {
          tab23.cells[j].innerHTML = listStudent[i][7] > 0 ? listStudent[i][7] : '--';
        }

        ;

        if (j == 5) {
          tab23.cells[j].innerHTML = listStudent[i][8] > 0 ? listStudent[i][8] : '--';
        }

        ;

        if (j == 6) {
          tab23.cells[j].innerHTML = listStudent[i][9] > 0 ? listStudent[i][9] : '--';
          /*listStudent[i][9][0]*/
        }
        ...
        if (j == 8) {
          tab23.cells[j].innerHTML = listStudent[i][11] > 0 ? listStudent[i][11] : '--';
      ...
      for (j = 0; j <= tab33.childElementCount - 1; j++) {
        if (j == 0) {
          tab33.cells[j].innerHTML = listStudent[i][12] > 0 ? listStudent[i][12] : '--';
        }

        ;

        if (j == 1) {
          tab33.cells[j].innerHTML = listStudent[i][13] > 0 ? listStudent[i][13] : '--';
        }

        ;

        if (j == 2) {
          tab33.cells[j].innerHTML = listStudent[i][14] > 0 ? listStudent[i][14] : '--';
        }
      ...
      for (j = 0; j <= tab116.childElementCount - 1; j++) {
        ...
        if (j == 2) {
          tab116.cells[j].innerHTML = "-/-";
          /*mydata[2].indexOf(listStudent[i][15][2]) + 1 /*moyuefcr + moyuepcr + moyuetcr*/
        } //moyuefcr + moyuepcr + moyuetcr
  ...
  function PageSynthese() {
    ...
    page4.children[0].children[2].children[0].innerHTML = "PROCES VERBAL MODULAIRE SYNTHESE 1<sup>er</sup> SEMESTRE EPS1  ".concat(mydata[11][0]['annee_academique']);
    ...
    page5.children[0].children[1].children[0].innerHTML = "PROCES VERBAL MODULAIRE SYNTHESE 1<sup>er</sup> SEMESTRE EPS1  ".concat(mydata[11][0]['annee_academique']);
    ...
    worktab2.children[0].children[0].innerHTML = "PROCES VERBAL MODULAIRE SYNTHESE ".concat(mydata[11][0]['annee_academique']);
    worktab3 = bigtab5.children[1];
    worktab3.children[0].children[0].innerHTML = "PROCES VERBAL MODULAIRE SYNTHESE ".concat(mydata[11][0]['annee_academique']);
    ...
    for (i = 0; i <= mydata[1].length - 1; i++) {
      ...
      for (j = 0; j <= tab23.childElementCount - 1; j++) {
        ...
        if (j == 9) {
          ...
          var uef9cr = synthese[i][11][7]; //if (synthese[i][9][0] < 10) { uef9cr = 0 }
      ...
      for (j = 0; j <= tab33.childElementCount - 1; j++) {
        ...
        if (j == 3) {
          var uef10cr = synthese[i][12][7]; //if (synthese[i][10][0] < 10) { uef10cr = 0 }

          var uef11cr = synthese[i][13][7]; //if (synthese[i][11][0] < 10) { uef11cr = 0 }

          var uef12cr = synthese[i][14][7]; //if (synthese[i][12][0] < 10) { uef12cr = 0 }
      ...
      for (j = 0; j <= tab116.childElementCount - 1; j++) {
        ...
        if (j == 2) {
          tab116.cells[j].innerHTML = mydata[10].indexOf(synthese[i][15][2]) + 1;
          /*moyuefcr + moyuepcr + moyuetcr*/
        } //moyuefcr + moyuepcr + moyuetcr
  ...
  function fullfill(clone, i) {
    ...
    line2.children[5].innerHTML = "".concat(mydata[11][0]['annee_academique']); //'2022/2023'
    //Line 3
