...
window.addEventListener('load', function () {
  ...
  function Page1() {
    ...
    for (i = 0; i <= mydata[1].length - 1; i++) {
      ...
      for (j = 0; j <= tab15.childElementCount - 1; j++) {
        ...
        if (j == 2) {
          tab15.cells[j].innerHTML = listStudent[i][3][0]; //if((listStudent[i][1][0]+listStudent[i][2][0])>=20){tab15.cells[j].innerHTML="V"}else{tab15.cells[j].innerHTML="NV"}
      ...
      for (j = 0; j <= tab33.childElementCount - 1; j++) {
        ...
        if (j == 1) {
          if (listStudent[i][7][2] < 10 || parseInt(tab15.cells[5].innerHTML) + parseInt(tab23.cells[3].innerHTML) < 30) {
        ...
        if (j == 2) {
          tab33.cells[j] = listStudent[i][1][7] + listStudent[i][2][7] + listStudent[i][3][7] + listStudent[i][4][7] + listStudent[i][5][7] + listStudent[i][6][7]; //console.log(parseInt(tab23.cells[3].innerHTML) + 3);
  ...
  function PageRattrapage() {
    ...
    for (i = 0; i <= mydata[1].length - 1; i++) {
      ...
      for (j = 0; j <= tab05.childElementCount - 1; j++) {
        if (j == 0) {
          tab05r.cells[j].innerHTML = i + 1; //tab005.cells[j].innerHTML = i+1;
        }

        if (j == 1) {
          tab05r.cells[j].innerHTML = listStudent[i][0]['nom']; //tab005.cells[j].innerHTML = listStudent[i][0]['nom'];
        }

        if (j == 2) {
          tab05r.cells[j].innerHTML = listStudent[i][0]['prenom']; //tab005.cells[j].innerHTML = listStudent[i][0]['prenom']
        }

        if (j == 3) {
          tab05r.cells[j].innerHTML = listStudent[i][0]['matricule']; //tab005.cells[j].innerHTML = listStudent[i][0]['date_naissance']
        }
      } //tab1
  ...
  function PageSynthese() {
    ...
    for (i = 0; i <= mydata[1].length - 1; i++) {
      ...
      worktab2.appendChild(temp2); //body.appendChild(page3)
    } //Ajoute de la ligne au grand tableau
    ...
    for (j = 0; j <= mydata[1].length - 1; j++) {
      ...
      for (k = 0; k <= 9; k++) {
        ...
        if (k == 5) {
          //SN
          if (i == 0) {
            td.innerHTML = "".concat(listStudent[j][1][10]);
          }

          if (i == 1) {
            td.innerHTML = "".concat(listStudent[j][2][10]);
          }

          if (i == 2) {
            td.innerHTML = "".concat(listStudent[j][3][10]);
          }

          if (i == 3) {
            td.innerHTML = "".concat(listStudent[j][4][10]);
          }

          if (i == 4) {
            td.innerHTML = "".concat(listStudent[j][5][10]);
          }

          if (i == 5) {
            td.innerHTML = "".concat(listStudent[j][6][10]);
          }
        }
