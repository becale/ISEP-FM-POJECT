    ...
    function Page1() { 
        ...
        for(i=0; i<=mydata[1].length-1; i++){
            ...
            for(j=0; j<=tab33.childElementCount-1; j++){
                ...
                if(j==3){tab33.cells[j].innerHTML = listStudent[i][1][7]+listStudent[i][2][7]+listStudent[i][3][7]+listStudent[i][4][7]+listStudent[i][5][7]+listStudent[i][6][7]}//listStudent[i][9][3]}; //Nombre de crédits
