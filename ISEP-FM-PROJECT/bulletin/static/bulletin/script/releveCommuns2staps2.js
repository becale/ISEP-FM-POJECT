window.addEventListener('load', () => {
    ...
    function Page1() {
        ...
        for (i = 0; i <= mydata[1].length - 1; i++) {
            ...
            for (j = 0; j <= tab23.childElementCount - 1; j++) {
                ...
                if (j == 1) { tab23.cells[j].innerHTML = listStudent[i][2][0] };
                if (j == 2) { tab23.cells[j].innerHTML = listStudent[i][3][0] };
                if (j == 3) { tab23.cells[j].innerHTML = listStudent[i][4][0] };
                ...
                if (j == 8) { tab23.cells[j].innerHTML = listStudent[i][9][0] };
                if (j == 9) { tab23.cells[j].innerHTML = listStudent[i][10][0] };

                //RECAPITULATIF UE PRO
                if (j == 10) { //Moyenne Groupe

                    var uep1cr = listStudent[i][1][6]
                    if (listStudent[i][1][0] < 10) { uep1cr = 0 }
                    ...
                    if ((listStudent[i][2][0] + listStudent[i][3][0] + listStudent[i][4][0] + listStudent[i][5][0]) < 40) { uep2345cr = 0 }

                    var uep6cr = listStudent[i][6][6]
                    if (listStudent[i][6][0] < 10) { uep6cr = 0 }

                    var uep7cr = listStudent[i][7][6]
                    if (listStudent[i][7][0] < 10) { uep7cr = 0 }

                    var uep8cr = listStudent[i][8][6]
                    if (listStudent[i][8][0] < 10) { uep8cr = 0 }

                    var uep9cr = listStudent[i][9][6]
                    if (listStudent[i][9][0] < 10) { uep9cr = 0 }

                    var uep10cr = listStudent[i][10][6]
                    if (listStudent[i][10][0] < 10) { uep10cr = 0 }
                    ...
                    } else { uep110cr = uep1cr + uep2345cr + uep6cr + uep7cr + uep8cr + uep9cr + uep10cr }

                    /**VERIFICATION MOYENNE ET NOTE ELIMINATOIRE */
                    moyuep = listStudent[i][10][3]

                    if (moyuep >= 10 && (listStudent[i][1][0] >= 7 && listStudent[i][2][0] >= 7 && listStudent[i][3][0] >= 7 && listStudent[i][4][0] >= 7 && listStudent[i][5][0] >= 7 && listStudent[i][6][0] >= 7 && listStudent[i][7][0] >= 7 && listStudent[i][8][0] >= 7 && listStudent[i][9][0] >= 7 && listStudent[i][10][0] >= 7)) {
            ...
            for (j = 0; j <= tab33.childElementCount - 1; j++) {
                ...
                if (j == 1) { tab33.cells[j].innerHTML = listStudent[i][12][0] };

                if (j == 2) {
                    var uet1 = listStudent[i][11][6]
                    if (listStudent[i][11][0] < 10) { uet1 = 0 }

                    var uet2 = listStudent[i][12][6]
                    if (listStudent[i][12][0] < 10) { uet2 = 0 }
                    ...
                    if (moyuet >= 10 && listStudent[i][11][0] >= 7 && listStudent[i][12][0] >= 7) {
    ...
    function PageRattrapage() {
        ...
        for (i = 0; i <= mydata[1].length - 1; i++) {
            ...
            for (j = 0; j <= tab33.childElementCount - 1; j++) {
                if (j == 0) {
                    if (rattrapage[i][11] > 0) { tab33.cells[j].innerHTML = rattrapage[i][11] } else { tab33.cells[j].innerHTML = '--' }
                };
            ...
            for (j = 0; j <= tab116.childElementCount - 1; j++) {
                if (j == 0) { tab116.cells[j].innerHTML = '--' } //total }
                if (j == 1) { tab116.cells[j].innerHTML = '--' }
                if (j == 2) { tab116.cells[j].innerHTML = '--' }
                if (j == 3) { tab116.cells[j].innerHTML = '--' } //rang }
    ...
    function PageSynthese() {
        ...
        for (i = 0; i <= mydata[1].length - 1; i++) {
            ...
            temp5 = worktab5.children[3].cloneNode(true)
            ...
            for (j = 0; j <= tab23.childElementCount - 1; j++) {
                if (j == 0) {
                    /*if (synthese[i][1] > 0) {*/
                    tab23.cells[j].innerHTML = synthese[i][1][0] /*} else { tab23.cells[j].innerHTML = '--' }*/
                };
                if (j == 1) {
                    /*if (synthese[i][2][0] > 0) {*/
                    tab23.cells[j].innerHTML = synthese[i][2][0] /*} else { tab23.cells[j].innerHTML = '--' }*/
                };
                if (j == 2) {
                    /*if (synthese[i][3][0] > 0) {*/
                    tab23.cells[j].innerHTML = synthese[i][3][0] /*} else { tab23.cells[j].innerHTML = '--' }*/
                };
                if (j == 3) {
                    /*if (synthese[i][4][0] > 0) {*/
                    tab23.cells[j].innerHTML = synthese[i][4][0] /*} else { tab23.cells[j].innerHTML = '--' }*/
                };
                if (j == 4) {
                    /*if (synthese[i][5][0] > 0) {*/
                    tab23.cells[j].innerHTML = synthese[i][5][0] /*} else { tab23.cells[j].innerHTML = '--' }*/
                };
                if (j == 5) {
                    /*if (synthese[i][6][0] > 0) {*/
                    tab23.cells[j].innerHTML = synthese[i][6][0] /*} else { tab23.cells[j].innerHTML = '--' }*/
                };
                if (j == 6) {
                    /*if (synthese[i][7][0] > 0) {*/
                    tab23.cells[j].innerHTML = synthese[i][7][0] /*} else { tab23.cells[j].innerHTML = '--' }*/
                };
                ...
                if (j == 7) {
                    ...
                    /*if (synthese[i][8] > 0) {*/
                    tab23.cells[j].innerHTML = synthese[i][8][0] /*} else { tab23.cells[j].innerHTML = '--' }*/
                };
                if (j == 8) {
                    /*if (synthese[i][9] > 0) {*/
                    tab23.cells[j].innerHTML = synthese[i][9][0] /*} else { tab23.cells[j].innerHTML = '--' }*/
                }
                if (j == 9) {
                    /*if (synthese[i][10] > 0) {*/
                    tab23.cells[j].innerHTML = synthese[i][10][0] /*} else { tab23.cells[j].innerHTML = '--' }*/
                }
                if (j == 10) {
                    var uep1cr = listStudent[i][1][6]
                    if (listStudent[i][1][0] < 10) { uep1cr = 0 }
                    ...
                    if (moyuep >= 10 && (synthese[i][1][0] >= 7 && synthese[i][2][0] >= 7 && synthese[i][3][0] >= 7 && synthese[i][4][0] >= 7 && synthese[i][5][0] >= 7 && synthese[i][6][0] >= 7 && synthese[i][7][0] >= 7 && synthese[i][8][0] >= 7 && synthese[i][9][0] >= 7 && synthese[i][10][0] >= 7)) {
                        //moyuefcr = uef34cr + uef12cr
                    } else {
                        moyuep = '--'
                    }
                ...
                if (j == 11) { tab23.cells[j].innerHTML = uep110cr }
            }
            ...
            for (j = 0; j <= tab33.childElementCount - 1; j++) {
                if (j == 0) { tab33.cells[j].innerHTML = synthese[i][11][0] };

                if (j == 1) { tab33.cells[j].innerHTML = synthese[i][12][0] };
                ...
                if (j == 2) {
                    ...
                    if (moyuet >= 10 && synthese[i][11][0] >= 7 && synthese[i][12][0] >= 7) {
