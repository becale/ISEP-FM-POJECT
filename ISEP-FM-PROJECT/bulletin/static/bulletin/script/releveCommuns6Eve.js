window.addEventListener('load', () => {
        ...
        for (i = 0; i <= mydata[1].length - 1; i++) {
            ...
            for (j = 0; j <= tab15.childElementCount - 1; j++) {
                ...
                if (j == 4) {
                    ...
                    if ((listStudent[i][1][0]) < 10) { uef11cr = 0 }

                    var uef22cr = listStudent[i][2][6]
                    if ((listStudent[i][2][0]) < 10) { uef22cr = 0 }

                    var uef33cr = listStudent[i][3][6]
                    if ((listStudent[i][3][0]) < 10) { uef33cr = 0 }

                    var uef44cr = listStudent[i][4][6]
                    if ((listStudent[i][4][0]) < 10) { uef44cr = 0 }
                    ...
                    if (moyuef1 >= 10 && (listStudent[i][1][0] >= 7 && listStudent[i][2][0] >= 7 && listStudent[i][3][0] >= 7 && listStudent[i][4][0] >= 7)) {
            ...
            for (j = 0; j <= tab23.childElementCount - 1; j++) {
                ...
                if (j == 2) {
                    ...
                    if ((listStudent[i][5][0]) < 10) { ues11cr = 0 }

                    var ues22cr = listStudent[i][6][6]
                    if ((listStudent[i][6][0]) < 10) { ues22cr = 0 }
                    ...
                    if (moyues1 >= 10 && listStudent[i][5][0] >= 7 && listStudent[i][6][0] >= 7) {
    ...
    function SyntheseAnnuelle() {
        ...
        bigtabS = pageS.children[0].children[1].children[1]

        //Tableau Sur lequel on ajoute les nouvelles lignes
        worktabS = bigtabS.children[1]

        for (i = 0; i <= mydata[1].length - 1; i++) {
            tempS = worktabS.children[3].cloneNode(true)
            ...
            for (j = 0; j <= tab15.childElementCount - 1; j++) {
                ...
                if (j == 4) {
                    ...
                    if ((syntheses5[i][1][0]) < 10) { uef1cr = 0 }

                    var uef2cr = syntheses5[i][2][5]
                    if ((syntheses5[i][2][0]) < 10) { uef2cr = 0 }

                    var uef3cr = syntheses5[i][3][5]
                    if ((syntheses5[i][3][0]) < 10) { uef3cr = 0 }

                    var uef4cr = syntheses5[i][4][5]
                    if ((syntheses5[i][4][0]) < 10) { uef4cr = 0 }
                    ...
                    if (moyuef >= 10 && (syntheses5[i][1][0] >= 7 && syntheses5[i][2][0] >= 7 && syntheses5[i][3][0] >= 7 && syntheses5[i][4][0] >= 7)) {
                        //moyuefcr = uef34cr + uef12cr
                    } else {
                        moyuef = '--'
                    }
            ...
            for (j = 0; j <= tab23.childElementCount - 1; j++) {
                ...
                if (j == 2) {
                    ...
                    if ((syntheses5[i][5][0]) < 10) { ues1cr = 0 }

                    var ues2cr = syntheses5[i][6][5]
                    if ((syntheses5[i][6][0]) < 10) { ues2cr = 0 }
                    ...
                    if (moyues >= 10 && syntheses5[i][5][0] >= 7 && syntheses5[i][6][0] >= 7) {
            ...
            for (j = 0; j <= tab15S.childElementCount - 1; j++) {
                ...
                if (j == 4) {
                    ...
                    if ((synthese[i][1][0]) < 10) { uef11cr = 0 }

                    var uef22cr = listStudent[i][2][6]
                    if ((listStudent[i][2][0]) < 10) { uef22cr = 0 }

                    var uef33cr = listStudent[i][3][6]
                    if ((synthese[i][3][0]) < 10) { uef33cr = 0 }

                    var uef44cr = listStudent[i][4][6]
                    if ((synthese[i][4][0]) < 10) { uef44cr = 0 }
                    ...
                    if (moyuef1 >= 10 && (synthese[i][1][0] >= 7 && synthese[i][2][0] >= 7 && synthese[i][3][0] >= 7 && synthese[i][4][0] >= 7)) {
                        //moyuefcr = uef34cr + uef12cr
                    } else {
                        moyuef1 = '--'
                    }
            ...
            for (j = 0; j <= tab23S.childElementCount - 1; j++) {
                ...
                if (j == 2) {
                    var ues11cr = listStudent[i][5][6]
                    if ((synthese[i][5][0]) < 10) { ues11cr = 0 }

                    var ues22cr = listStudent[i][6][6]
                    if ((synthese[i][6][0]) < 10) { ues22cr = 0 }
                    ...
                    if (moyues1 >= 10 && synthese[i][5][0] >= 7 && synthese[i][6][0] >= 7) {
    ...
    function ListeAdmis() {
        ...
        //Tbody
        worktabA = pageA.children[0].children[1].children[1].children[1]
        ...
        for (i = 0; i <= mydata[1].length - 1; i++) {
            ...
            for (j = 0; j <= tempA.childElementCount - 1; j++) {
                if (j == 0) { tempA.cells[j].innerHTML = i + 1 }
                if (j == 1) { tempA.cells[j].innerHTML = moyCredit[i][0]['matricule'] }
                if (j == 2) { tempA.cells[j].innerHTML = `${ moyCredit[i][0]['nom']}  ${ moyCredit[i][0]['prenom']}` }
                if (j == 3) {
                    if (moyCredit[i][0]['sexe'] == "MASCULIN") { tempA.cells[j].innerHTML = 'M' } else if (moyCredit[i][0]['sexe'] == "FEMININ") { tempA.cells[j].innerHTML = 'F' }
                }
                if (j == 4) {
                    tempA.cells[j].innerHTML = moyCredit[i][7][3]['moyS1']
                    if (moyCredit[i][7][3]['moyS1'] == null) { tempA.cells[j].innerHTML = '--' }
                }
                if (j == 5) {
                    tempA.cells[j].innerHTML = moyCredit[i][7][3]['crS1']
                    if (moyCredit[i][7][3]['crS1'] == null) { tempA.cells[j].innerHTML = '--' }
                }
                if (j == 6) {
                ...
                if (j == 7) {
                    ...
                    if (moyCredit[i][7][3]['crS2'] == null) { tempA.cells[j].innerHTML = '--' }
                }
                if (j == 8) {
                    tempA.cells[j].innerHTML = moyCredit[i][7][3]['moyS3']
                    if (moyCredit[i][7][3]['moyS3'] == null) { tempA.cells[j].innerHTML = '--' }
                }
                if (j == 9) {
                    tempA.cells[j].innerHTML = moyCredit[i][7][3]['crS3']
                    if (moyCredit[i][7][3]['crS3'] == null) { tempA.cells[j].innerHTML = '--' }
                }
                if (j == 10) {
                    tempA.cells[j].innerHTML = moyCredit[i][7][3]['moyS4']
                    if (moyCredit[i][7][3]['moyS4'] == null) { tempA.cells[j].innerHTML = '--' }
                }
                if (j == 11) {
                    tempA.cells[j].innerHTML = moyCredit[i][7][3]['crS4']
                    if (moyCredit[i][7][3]['crS4'] == null) { tempA.cells[j].innerHTML = '--' }
                }
                if (j == 12) {
                    tempA.cells[j].innerHTML = moyCredit[i][7][3]['moyS5']
                    if (moyCredit[i][7][3]['moyS5'] == null) { tempA.cells[j].innerHTML = '--' }
                }
                if (j == 13) {
                    tempA.cells[j].innerHTML = moyCredit[i][7][3]['crS5']
                    if (moyCredit[i][7][3]['crS5'] == null) { tempA.cells[j].innerHTML = '--' }
                }
                if (j == 14) {
                    tempA.cells[j].innerHTML = moyCredit[i][7][3]['moyS6']
                    if (moyCredit[i][7][3]['moyS6'] == null) { tempA.cells[j].innerHTML = '--' }
                }
                if (j == 15) {
                    tempA.cells[j].innerHTML = moyCredit[i][7][3]['crS6']
                    if (moyCredit[i][7][3]['crS6'] == null) { tempA.cells[j].innerHTML = '--' }
                }
                if (j == 16) {
                ...
                if (j == 17) { tempA.cells[j].innerHTML = sommeCrInt6(tempA.cells[5].innerHTML, tempA.cells[7].innerHTML, tempA.cells[9].innerHTML, tempA.cells[11].innerHTML, tempA.cells[13].innerHTML, tempA.cells[15].innerHTML) }
            }
    ...
    function fullfill(clone, i) {
        ...
        for (j = 0; j <= mydata[1].length - 1; j++) {
            ...
            for (k = 0; k <= 9; k++) {
                ...
                if (k == 3) { //CC
                    if (i == 0) { td.innerHTML = `${listStudent[j][1][8]}`; /*OK*/ }
                    if (i == 1) { td.innerHTML = `${listStudent[j][2][8]}`; /*OK*/ }
                    if (i == 2) { td.innerHTML = `${listStudent[j][3][8]}`; /*OK*/ }
                    if (i == 3) { td.innerHTML = `${listStudent[j][4][8]}`; /*OK*/ }
                    if (i == 4) { td.innerHTML = `${listStudent[j][5][8]}`; /*OK*/ }
                    if (i == 5) { td.innerHTML = `${listStudent[j][6][8]}`; /*OK*/ }
                ...
                if (k == 5) { //SN
                    if (i == 0) { td.innerHTML = `${listStudent[j][1][9]}`; /*OK*/ }
                    if (i == 1) { td.innerHTML = `${listStudent[j][2][9]}`; /*OK*/ }
                    if (i == 2) { td.innerHTML = `${listStudent[j][3][9]}`; /*OK*/ }
                    if (i == 3) { td.innerHTML = `${listStudent[j][4][9]}`; /*OK*/ }
                    if (i == 4) { td.innerHTML = `${listStudent[j][5][9]}`; /*OK*/ }
                    if (i == 5) { td.innerHTML = `${listStudent[j][6][9]}`; /*OK*/ }
                }
                if (k == 6) { //Moyenne
                    if (i == 0) {
                    ...
                    if (i == 1) { td.innerHTML = `${listStudent[j][2][0]}`; /*OK*/ }
                    if (i == 2) { td.innerHTML = `${listStudent[j][3][0]}`; /*OK*/ }
                    if (i == 3) { td.innerHTML = `${listStudent[j][4][0]}`; /*OK*/ }
                    if (i == 4) { td.innerHTML = `${listStudent[j][5][0]}`; /*OK*/ }
                    if (i == 5) { td.innerHTML = `${listStudent[j][6][0]}`; /*OK*/ }
                }
                if (k == 7) { //Crédit
                    if (i == 0) { td.innerHTML = `${listStudent[j][1][7]}`; /*OK*/ }
                    if (i == 1) { td.innerHTML = `${listStudent[j][2][7]}`; /*OK*/ }
                    if (i == 2) { td.innerHTML = `${listStudent[j][3][7]}`; /*OK*/ }
                    if (i == 3) { td.innerHTML = `${listStudent[j][4][7]}`; /*OK*/ }
                    if (i == 4) { td.innerHTML = `${listStudent[j][5][7]}`; /*OK*/ }
                    if (i == 5) { td.innerHTML = `${listStudent[j][6][7]}`; /*OK*/ }
                }
                if (k == 8) { //Decision
                    if (i == 0) { if (listStudent[j][1][5]) { td.innerHTML = 'Validée' } else { td.innerHTML = 'Non Validée' }; /*OK*/ }
                    if (i == 1) { if (listStudent[j][2][5]) { td.innerHTML = 'Validée' } else { td.innerHTML = 'Non Validée' }; /*OK*/ }
                    if (i == 2) { if (listStudent[j][3][5]) { td.innerHTML = 'Validée' } else { td.innerHTML = 'Non Validée' }; /*OK*/ }
                    if (i == 3) { if (listStudent[j][4][5]) { td.innerHTML = 'Validée' } else { td.innerHTML = 'Non Validée' }; /*OK*/ }
                    if (i == 4) { if (listStudent[j][5][5]) { td.innerHTML = 'Validée' } else { td.innerHTML = 'Non Validée' }; /*OK*/ }
                    if (i == 5) { if (listStudent[j][6][5]) { td.innerHTML = 'Validée' } else { td.innerHTML = 'Non Validée' }; /*OK*/ }
                }
                if (k == 9) { //Mention
                    if (i == 0) {
